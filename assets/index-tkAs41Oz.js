(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();let g={},B=[];try{B=JSON.parse(localStorage.getItem("asist_personalizados")||"[]")}catch{B=[]}let ne=JSON.parse(localStorage.getItem("asist_historial")||"[]"),ue=null,Ie=JSON.parse(localStorage.getItem("clase_base_config")||"{}"),K=null,P=JSON.parse(localStorage.getItem("horas_log")||"[]"),ie={};try{ie=JSON.parse(localStorage.getItem("asist_empty_modules")||"{}")}catch{ie={}}let T="dashboard";const U=new Date().toISOString().split("T")[0];if(B.length===0&&P.some(e=>(e==null?void 0:e._tipo)==="personalizado")){const e=new Map;P.filter(t=>(t==null?void 0:t._tipo)==="personalizado").forEach((t,o)=>{const a=Number(t._pid),n=Number.isFinite(a)&&a>0?a:Date.now()+o;e.has(n)||e.set(n,{id:n,nombre:t.curso||"Clase personalizada",tel:"",clases:[]});const s=e.get(n);t.fecha&&!s.clases.some(i=>i.fecha===t.fecha)&&s.clases.push({fecha:t.fecha,val:["Presente","Falta","Permiso"].includes(t.obsv)?t.obsv:"Presente",horas:t.horas||"",horaInicio:t.entrada||"",horaFin:t.salida||""})}),B=[...e.values()].sort((t,o)=>t.nombre.localeCompare(o.nombre,"es",{sensitivity:"base"})),localStorage.setItem("asist_personalizados",JSON.stringify(B))}function qe(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("asist_theme",e);const t=document.getElementById("themeLabel");t&&(t.textContent=e==="dark"?"🌙 Modo oscuro":"☀️ Modo claro")}function Gt(){const e=document.documentElement.getAttribute("data-theme")||"dark";qe(e==="dark"?"light":"dark")}function p(e){const t=document.getElementById("toast");t&&(t.textContent=e,t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),3e3))}function C(e,t,o,a){const n=document.getElementById("overlay"),s=document.getElementById("mTitle"),i=document.getElementById("mBody"),r=document.getElementById("mExtra"),l=document.getElementById("mOk");n&&(s.textContent=e||"",i.textContent=t||"",r.innerHTML=a||"",l.style.display=o?"inline-block":"none",l.onclick=()=>{typeof o=="function"&&o()},n.classList.add("show"))}function w(){const e=document.getElementById("overlay");e&&e.classList.remove("show")}function z(){localStorage.setItem("asist_state",JSON.stringify(g))}function Q(e,t,o){ne.unshift({icon:e,msg:t,ctx:o,ts:Date.now()}),ne.length>200&&ne.pop(),localStorage.setItem("asist_historial",JSON.stringify(ne))}function Jt(){const e=document.getElementById("sidebar"),t=document.getElementById("sidebarOverlay");e&&e.classList.toggle("hidden"),t&&t.classList.toggle("show")}function Wt(e){const t=document.getElementById("globalResults");if(!t)return;if(!e.trim()){t.classList.remove("show");return}const o=[];pe().forEach(a=>{const n=g[a];n&&n.alumnos.forEach(s=>{s.nombre.toLowerCase().includes(e.toLowerCase())&&o.push({nombre:s.nombre,curso:a})})}),B.forEach(a=>{a.nombre.toLowerCase().includes(e.toLowerCase())&&o.push({nombre:a.nombre,curso:"Personalizado"})}),o.length===0?t.innerHTML='<div class="gr-empty">Sin resultados</div>':t.innerHTML=o.slice(0,8).map(a=>`<div class="gr-item"><div class="gr-name">${a.nombre}</div><div class="gr-sub">${a.curso}</div></div>`).join(""),t.classList.add("show")}function Ut(){const e=document.getElementById("globalResults");e&&e.classList.remove("show")}function Ge(e,t){if(!e||!t)return 0;const[o,a]=e.split(":").map(Number),[n,s]=t.split(":").map(Number),i=n*60+s-(o*60+a);return i>0?Math.round(i/60*10)/10:0}function _e(){localStorage.setItem("horas_log",JSON.stringify(P))}const Re={};function Oe(e){return JSON.parse(JSON.stringify(e??null))}function qt(e){const t=k(e);return Oe({alumnos:t.alumnos||[],retirados:t.retirados||[],asistencias:t.asistencias||{},fechas:t.fechas||[],motivos:t.motivos||{},notas:t.notas||{},participacion:t.participacion||{},emptiedAt:ie[e]&&(t.alumnos||[]).length===0?new Date(ie[e]).toISOString():null})}function Vt(e){return e&&g[e]?[e]:!e&&T&&g[T]?[T]:[]}async function Ve(e){if(!Fe()||!e||!g[e])return!1;const t=qt(e);if(new Blob([JSON.stringify(t)]).size<8e5){t.updatedAt=firebase.firestore.FieldValue.serverTimestamp(),t._chunked=!1,await K.collection("modulos").doc(e).set(t);const d=["__alumnos","__asistencias","__extras"],c=K.batch();d.forEach(u=>{c.delete(K.collection("modulos").doc(e+u))});try{await c.commit()}catch{}return!0}const n=K.batch(),s=K.collection("modulos").doc(e),i=K.collection("modulos").doc(e+"__alumnos"),r=K.collection("modulos").doc(e+"__asistencias"),l=K.collection("modulos").doc(e+"__extras");return n.set(s,{_chunked:!0,fechas:t.fechas||[],emptiedAt:t.emptiedAt||null,updatedAt:firebase.firestore.FieldValue.serverTimestamp()}),n.set(i,Oe({alumnos:t.alumnos||[],retirados:t.retirados||[]})),n.set(r,Oe({asistencias:t.asistencias||{}})),n.set(l,Oe({motivos:t.motivos||{},notas:t.notas||{},participacion:t.participacion||{}})),await n.commit(),!0}function V(e){z();const t=Vt(e);return!Fe()||t.length===0?Promise.resolve(!1):(t.forEach(o=>{clearTimeout(Re[o]),Re[o]=setTimeout(()=>{delete Re[o],Ve(o).catch(a=>{console.error("Error sincronizando modulo:",o,a),p("No se pudo sincronizar con Firebase: "+a.message)})},350)}),Promise.resolve(!0))}function Te(e,t,o,a,n){return V(e)}function Xe(e,t,o){return z(),Fe()?Ve(e):Promise.resolve(!1)}function yt(e,t){return z(),Fe()?Ve(e):Promise.resolve(!1)}function Ee(){localStorage.setItem("asist_personalizados",JSON.stringify(B))}function Xt(e){return V(e)}function Kt(e){return V(e)}function mt(e){return String(e||"").trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function Qt(e){return["Presente","Falta","Permiso"].includes(e==null?void 0:e.obsv)?e.obsv:"Presente"}function Yt(e){const t=new Map;return(e||[]).filter(o=>o&&(o._tipo==="personalizado"||String(o._uid||"").startsWith("pers_"))).forEach((o,a)=>{const n=Number(o._pid),s=Number.isFinite(n)&&n>0?n:Date.now()+a;t.has(s)||t.set(s,{id:s,nombre:o.curso||"Clase personalizada",tel:"",clases:[],_lastFecha:""});const i=t.get(s);o.fecha&&String(o.fecha).localeCompare(i._lastFecha||"")>=0&&o.curso&&(i.nombre=o.curso,i._lastFecha=o.fecha),o.fecha&&!i.clases.some(r=>r.fecha===o.fecha)&&i.clases.push({fecha:o.fecha,val:Qt(o),horas:o.horas||"",horaInicio:o.entrada||"",horaFin:o.salida||""})}),[...t.values()].map(({_lastFecha:o,...a})=>a)}function Zt(e){const t=Array.isArray(e==null?void 0:e.personalizados)?e.personalizados:[],o=Yt(Array.isArray(e==null?void 0:e.horasLog)?e.horasLog:[]),a=t.length>0?t:o;if(a.length===0)return{alumnos:0,clases:0,horas:0};let n=0,s=0;a.forEach(r=>{const l=String(r.id||"");let d=B.find(c=>String(c.id)===l);d||(d=B.find(c=>mt(c.nombre)===mt(r.nombre))),d||(d={...r,id:r.id||Date.now()+Math.random(),clases:[]},B.push(d),n++),Array.isArray(d.clases)||(d.clases=[]),(r.clases||[]).forEach(c=>{if(!(c!=null&&c.fecha))return;const u=d.clases.find(m=>m.fecha===c.fecha);u?(!u.val&&c.val&&(u.val=c.val),!u.horas&&c.horas&&(u.horas=c.horas),!u.horaInicio&&c.horaInicio&&(u.horaInicio=c.horaInicio),!u.horaFin&&c.horaFin&&(u.horaFin=c.horaFin)):(d.clases.push({...c}),s++)}),d.clases.sort((c,u)=>String(c.fecha).localeCompare(String(u.fecha)))});let i=0;return((e==null?void 0:e.horasLog)||[]).filter(r=>r&&(r._tipo==="personalizado"||String(r._uid||"").startsWith("pers_"))).forEach(r=>{const l=r._uid||`pers_${r._pid||r.curso}_${r.fecha}`;P.some(c=>String(c._uid||"")===String(l))||P.some(c=>c._tipo==="personalizado"&&String(c._pid||"")===String(r._pid||"")&&c.fecha===r.fecha)||(P.push({...r,_uid:l,_tipo:"personalizado"}),i++)}),B.sort((r,l)=>r.nombre.localeCompare(l.nombre,"es",{sensitivity:"base"})),Ee(),_e(),{alumnos:n,clases:s,horas:i}}function kt(){}function eo(){}function xt(){const e=document.getElementById("adminCarrerasList");e&&(e.innerHTML=_.map(t=>`
  ...
  `,()=>{const t=document.getElementById("newCarreraNombre").value.trim(),o=document.getElementById("newCarreraIcono").value.trim()||"📚";if(!t){p("⚠️ Escribe un nombre");return}const a="carrera_"+Date.now().toString(36),n={id:a,nombre:t,icono:o,color:"var(--violet)",secciones:[{id:a+"_M1",label:"Turno Mañana - Módulo 1",badge:"M1"}]};_.push(n),localStorage.setItem("asist_carreras",JSON.stringify(_)),w(),p("✅ Carrera creada"),setTimeout(()=>location.reload(),1e3)})}function $t(e){const t=String(e||"");if(/^\d{4}-\d{2}-\d{2}$/.test(t))return t.slice(0,7);const o=t.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/);return o?`${o[3]}-${String(o[2]).padStart(2,"0")}`:""}function Ke(e){const t=String(e||"");if(/^\d{4}-\d{2}-\d{2}$/.test(t)){const[o,a,n]=t.split("-");return`${n}/${a}/${o}`}return t||"—"}function no(e){if(!e)return"";const[t,o]=e.split("-").map(Number);return new Date(t,o-1,1).toLocaleDateString("es-ES",{month:"long",year:"numeric"})}function Et(e){var t;return e._tipo==="modulo"?e._grupo||((t=F(e._key))==null?void 0:t.carrera.id)||$:e._grupo||$}function ao(){var t;const e=((t=document.getElementById("horasFiltroMes"))==null?void 0:t.value)||"";return P.filter(o=>o&&o.fecha).filter(o=>Et(o)===$||!$).filter(o=>!e||$t(o.fecha)===e).sort((o,a)=>String(o.fecha).localeCompare(String(a.fecha))||String(o.curso||"").localeCompare(String(a.curso||"")))}function St(){const e=document.getElementById("horasFiltroMes");if(!e)return;const t=e.value,o=[...new Set(P.filter(a=>Et(a)===$||!$).map(a=>$t(a.fecha)).filter(Boolean))].sort().reverse();e.innerHTML='<option value="">Todos los meses</option>'+o.map(a=>`<option value="${a}">${no(a)}</option>`).join(""),t&&o.includes(t)&&(e.value=t)}function pt(e){return e._key||(e._tipo==="personalizado"?`pers_${e._pid||e.curso}`:e.curso||"manual")}function so(e,t){const o=pt(e),a=[...new Set(t.filter(r=>pt(r)===o).map(r=>r.fecha))].sort(),n=a.indexOf(e.fecha),s=Ie[o];if(!s||!s.fecha||!s.numero)return n>=0?n+1:"";const i=a.indexOf(s.fecha);return i===-1||n===-1?n+1:Math.max(1,Number(s.numero)+n-i)}function je(e,t,o,a){const n=document.getElementById(e);if(n){if(t.length===0){n.innerHTML=`<tr><td colspan="12"><div class="empty"><div class="ei">📋</div>${a}</div></td></tr>`;return}n.innerHTML=t.map(s=>{const i=String(s._uid||s.id),r=so(s,o),l=s._tipo==="manual";return`
      <tr>
        <td style="font-family:'JetBrains Mono',monospace;color:var(--muted)">${r}</td>
        <td>${s._tipo==="modulo"?"📚":s._tipo==="personalizado"?"👤":"✏️"}</td>
        <td>${s.dia||""}</td>
        <td style="font-family:'JetBrains Mono',monospace">${Ke(s.fecha)}</td>
        <td>${s.curso||""}</td>
    ...
    <div class="stats-grid" style="grid-template-columns:repeat(5,1fr);margin-bottom:16px">
    ...
    </div>`}function ro(e){const t=document.getElementById("horasFuentesGrid");if(!t)return;const a=me($).map(n=>{const s=F(n),i=e.filter(l=>l._tipo==="modulo"&&l._key===n).length,r=e.filter(l=>l._tipo==="modulo"&&l._key===n).reduce((l,d)=>l+(Number.parseFloat(d.horas)||0),0);return`<div class="stat" style="padding:12px 14px">
      ...
      <div style="font-family:'JetBrains Mono',monospace;color:var(--green-l);font-size:.78rem;margin-top:3px">${r.toFixed(1)} h</div>
    </div>`});t.innerHTML=a.join("")}function ge(){T==="horas"&&et(!1,!1),St();const e=ao(),t=e.filter(l=>l._tipo==="modulo"),o=e.filter(l=>l._tipo==="personalizado"),a=e.filter(l=>l._tipo==="manual");io(e),ro(e),je("horasTbodyMod",t,e,"Sin clases de módulos para este filtro."),je("horasTbodyPers",o,e,"Sin clases personalizadas para este filtro."),je("horasTbodyMan",a,e,"Sin entradas manuales para este filtro.");const n=document.getElementById("horasModTotal"),s=document.getElementById("horasPersTotal");n&&(n.textContent=`${t.length} / ${t.reduce((l,d)=>l+(Number.parseFloat(d.horas)||0),0).toFixed(1)} h`),s&&(s.textContent=`${o.length} / ${o.reduce((l,d)=>l+(Number.parseFloat(d.horas)||0),0).toFixed(1)} h`);const i=document.getElementById("horasManualesWrap");i&&(i.style.display=a.length?"block":"none");const r=document.getElementById("horasTbody");r&&(r.innerHTML=e.map(l=>`<tr><td>${l.fecha}</td><td>${l.curso}</td><td>${l.horas}</td></tr>`).join(""))}function wt(){const e=document.getElementById("claseBaseCurso");e&&(e.innerHTML=me($).map(o=>{const a=F(o);return`<option value="${o}">${(a==null?void 0:a.seccion.label)||o}</option>`}).join(""));const t=document.getElementById("claseBaseFecha");t&&!t.value&&(t.value=U),St()}function Je(e,t){const o=document.getElementById("claseBaseStatus");o&&T==="horas"&&(o.textContent=`Clase registrada para ${Ke(t)}.`)}function lo(){var s,i,r;const e=(s=document.getElementById("claseBaseCurso"))==null?void 0:s.value,t=(i=document.getElementById("claseBaseFecha"))==null?void 0:i.value,o=Number.parseInt((r=document.getElementById("claseBaseNumero"))==null?void 0:r.value);if(!e){p("Selecciona un curso");return}if(!t){p("Selecciona una fecha de referencia");return}if(!o||o<1){p("Indica un número de clase válido");return}const a=F(e);Ie[e]={fecha:t,numero:o,label:(a==null?void 0:a.seccion.label)||e},localStorage.setItem("clase_base_config",JSON.stringify(Ie));const n=document.getElementById("claseBaseStatus");n&&(n.innerHTML=`<span style="font-size:.78rem;color:var(--green-l)">Referencia guardada: ${Ie[e].label} · clase ${o} el ${Ke(t)}</span>`),ge(),p("Número de clase actualizado")}function co(e,t,o,a=!0){const n=P.find(s=>String(s._uid||s.id)===String(e));if(n){if(t==="horas"?n[t]=Number.parseFloat(o)||0:t==="alumnos"?n[t]=Number.parseInt(o)||0:n[t]=o,(t==="entrada"||t==="salida")&&n.entrada&&n.salida){const s=Ge(n.entrada,n.salida);s>0&&(n.horas=s)}_e(),a&&ge()}}function uo(e){C("Eliminar entrada","¿Seguro que deseas quitar esta entrada manual del registro de horas?",()=>{P=P.filter(t=>String(t._uid||t.id)!==String(e)),_e(),w(),ge(),p("Entrada eliminada")})}function mo(){C("🗑 Limpiar historial","¿Seguro que deseas borrar todo el historial de cambios? Esta acción no se puede deshacer.",()=>{ne=[],localStorage.setItem("asist_historial",JSON.stringify(ne)),w(),p("🗑 Historial eliminado")})}function po(){const e={state:g,personalizados:B,historial:ne,carreras:_,horasLog:P,claseBaseConfig:Ie,googleSheetsSync:se},t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),o=document.createElement("a");o.href=URL.createObjectURL(t),o.download=`backup_asistencias_${U}.json`,o.click(),p("💾 Backup exportado")}function fo(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{const o=t.target.files[0];if(!o)return;const a=new FileReader;a.onload=n=>{try{const s=JSON.parse(n.target.result);C("📥 Importar Backup","",null,`
          <div style="display:flex;flex-direction:column;gap:12px;margin-top:12px;">
        ...
        `),document.getElementById("btnRestaurarTodo").onclick=()=>{s.state&&(g=s.state),s.personalizados&&(B=s.personalizados,Ee()),s.historial&&(ne=s.historial,localStorage.setItem("asist_historial",JSON.stringify(ne))),s.carreras&&(_=s.carreras,localStorage.setItem("asist_carreras",JSON.stringify(_))),s.horasLog&&(P=s.horasLog),s.claseBaseConfig&&(Ie=s.claseBaseConfig),(s.googleSheetsSync||s.googleSheetsSyncConfig||s.google_sheets_sync)&&(se=s.googleSheetsSync||s.googleSheetsSyncConfig||s.google_sheets_sync,Ze()),z(),_e(),w(),p("📂 Backup completo restaurado"),setTimeout(()=>location.reload(),1e3)},document.getElementById("btnRestaurarPersonalizados").onclick=()=>{const r=Zt(s);if(w(),ve(),T==="horas"&&ge(),r.alumnos===0&&r.clases===0&&r.horas===0){p("⚠️ El backup no contiene clases personalizadas para fusionar");return}p(`✅ Personalizados fusionados: ${r.alumnos} alumno(s), ${r.clases} clase(s), ${r.horas} hora(s)`)},document.getElementById("btnRestaurarSheets").onclick=()=>{const r=Fo(s);if(w(),r===0){p("⚠️ El backup no contiene configuración de Google Sheets");return}p(`✅ Configuración Google Sheets fusionada: ${r} módulo(s)`)},document.getElementById("btnRestaurarRedes").onclick=()=>{s.state?(Object.keys(s.state).forEach(r=>{r.startsWith("redes_")&&(g[r]=s.state[r])}),z(),w(),p("✅ Asistencias de Redes & TICs recuperadas"),setTimeout(()=>location.reload(),1e3)):p("⚠️ El archivo no contiene datos de estado válidos")}}catch{p("❌ Backup inválido")}},a.readAsText(o)},e.click()}qe(localStorage.getItem("asist_theme")||document.documentElement.getAttribute("data-theme")||"dark");const It=[{id:"redes",nombre:"Redes & TICs",icono:"🖥️",color:"var(--amber)",secciones:[{id:"redes_M_1",label:"Turno Mañana - Módulo 1",badge:"Mañana M1"},{id:"redes_M_2",label:"Turno Mañana - Módulo 2",badge:"Mañana M2"},{id:"redes_M_3",label:"Turno Mañana - Módulo 3",badge:"Mañana M3"},{id:"redes_M_4",label:"Turno Mañana - Módulo 4",badge:"Mañana M4"},{id:"redes_T_1",label:"Turno Tarde - Módulo 1",badge:"Tarde M1"},{id:"redes_T_2",label:"Turno Tarde - Módulo 2",badge:"Tarde M2"},{id:"redes_T_3",label:"Turno Tarde - Módulo 3",badge:"Tarde M3"},{id:"redes_T_4",label:"Turno Tarde - Módulo 4",badge:"Tarde M4"}]},{id:"info_gastro",nombre:"Tecnologías de la Información",icono:"👨‍🍳",color:"var(--teal)",secciones:[{id:"info_gastro_L_1",label:"Clase Lunes",badge:"Lunes"}]},{id:"tics_sabados",nombre:"Tecnologías Turno mañana sábados",icono:"📅",color:"var(--violet)",googleSheetCsvUrl:"",secciones:[{id:"tics_S_1",label:"Turno Sábado - Módulo 1",badge:"Sáb M1"},{id:"tics_S_2",label:"Turno Sábado - Módulo 2",badge:"Sáb M2"},{id:"tics_S_3",label:"Turno Sábado - Módulo 3",badge:"Sáb M3"},{id:"tics_S_4",label:"Turno Sábado - Módulo 4",badge:"Sáb M4"}]}];let _=null;var ht;try{let e=JSON.parse(localStorage.getItem("asist_carreras"));if(e&&e.length){const t=new Set;e=e.filter(s=>t.has(s.id)?!1:(t.add(s.id),!0));const o=s=>(s||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]/g," ").replace(/\s+/g," ").trim();e=e.filter(s=>s.id==="tics_sabados"?!0:!o(s.nombre).includes("sabado"));const a=It.find(s=>s.id==="tics_sabados"),n=e.find(s=>s.id==="tics_sabados");!n&&a?e.push(a):n&&a&&!n.googleSheetCsvUrl&&(n.googleSheetCsvUrl=a.googleSheetCsvUrl),(ht=n==null?void 0:n.googleSheetCsvUrl)!=null&&ht.includes("docs.google.com/spreadsheets/d/")&&(n.googleSheetCsvUrl=""),localStorage.setItem("asist_carreras",JSON.stringify(e)),_=e}}catch{}_||(_=It);let $=localStorage.getItem("currentGrupo");var bt;(!$||!_.find(e=>e.id===$))&&($=((bt=_[0])==null?void 0:bt.id)||"redes");function pe(){return _.flatMap(e=>e.secciones.map(t=>t.id))}function me(e){const t=_.find(o=>o.id===e);return t?t.secciones.map(o=>o.id):[]}function F(e){for(const t of _){const o=t.secciones.find(a=>a.id===e);if(o)return{carrera:t,seccion:o}}return null}function Me(e){if(e.includes("-")){const n=e.split("-");return{prefix:n[0],num:Number.parseInt(n[1])||1,isLegacy:!0}}const t=e.split("_"),o=Number.parseInt(t.pop())||1;return{prefix:t.join("_"),num:o,isLegacy:!1}}function go(e){const t=localStorage.getItem("asist_state");if(t)try{const o=JSON.parse(t),a={...o};let n=!1;for(const[s,i]of Object.entries(e))o[s]&&(o[s].alumnos||[]).length>0&&(a[i]=a[i]?{...a[i],...o[s]}:o[s],delete a[s],n=!0);n&&localStorage.setItem("asist_state",JSON.stringify(a))}catch(o){console.warn("Error en migración de asist_state",o)}}function vo(e){const t=localStorage.getItem("horas_log");if(t)try{const o=JSON.parse(t);let a=!1;o.forEach(n=>{var s;if(e[n._key]&&(n._key=e[n._key],a=!0),(s=n._uid)!=null&&s.startsWith("mod_"))for(const[i,r]of Object.entries(e))n._uid.includes(`_${i}_`)&&(n._uid=n._uid.replaceAll(`_${i}_`,`_${r}_`),a=!0)}),a&&localStorage.setItem("horas_log",JSON.stringify(o))}catch(o){console.warn("Error en migración de horas_log",o)}}(function(){const t={"M-1":"redes_M_1","M-2":"redes_M_2","M-3":"redes_M_3","M-4":"redes_M_4","T-1":"redes_T_1","T-2":"redes_T_2","T-3":"redes_T_3","T-4":"redes_T_4","G-1":"info_gastro_L_1","G-2":"info_gastro_L_2","G-3":"info_gastro_L_3","G-4":"info_gastro_L_4"};go(t),vo(t)})();try{const e=JSON.parse(localStorage.getItem("asist_state")||"{}");e&&typeof e=="object"&&Object.assign(g,e)}catch{}pe().forEach(e=>{g[e]?(g[e].alumnos||(g[e].alumnos=[]),g[e].retirados||(g[e].retirados=[]),g[e].asistencias||(g[e].asistencias={}),g[e].fechas||(g[e].fechas=[]),g[e].motivos||(g[e].motivos={}),g[e].notas||(g[e].notas={}),g[e].participacion||(g[e].participacion={})):g[e]={alumnos:[],retirados:[],asistencias:{},fechas:[],motivos:{},notas:{},participacion:{}}});document.getElementById("topbarDate").textContent=new Date().toLocaleDateString("es",{weekday:"long",year:"numeric",month:"long",day:"numeric"});const ft=localStorage.getItem("fb_config");if(ft)try{lt(ct(ft))}catch{}pe().forEach(e=>{const t=document.createElement("div");t.className="page",t.id=`page-${e}`,t.innerHTML=To(e),document.querySelector(".content").appendChild(t)});_.forEach(e=>{const t=document.createElement("div");t.className="page",t.id=`page-carrera_${e.id}`,t.innerHTML=Ao(e),document.querySelector(".content").appendChild(t)});Ye();He();function ho(e){let t=0;for(let a=0;a<Math.min(e.length,5);a++){const n=e[a].join(" ").toLowerCase();if(n.includes("apellido")||n.includes("nombre")||n.includes("dni")){t=a;break}}const o=e[t].map(a=>String(a||"").trim().toLowerCase());return{headerIdx:t,idxNombre:o.findIndex(a=>a.includes("apellido")||a.includes("nombre")),idxDni:o.indexOf("dni"),idxCorreo:o.findIndex(a=>a.includes("correo")||a.includes("email")),idxNac:o.findIndex(a=>a.includes("nac")||a.includes("nacimiento")),idxCel:o.findIndex(a=>a.includes("celular")||a.includes("tel")||a.includes("cel")),idxEdad:o.indexOf("edad")}}function bo(e){if(!e||e.length<2)return[];const t=ho(e),o=[];for(let a=t.headerIdx+1;a<e.length;a++){const n=e[a],s=String(n[Math.max(0,t.idxNombre)]||"").trim();if(!s||s.length<3)continue;const i=s.toLowerCase();i.includes("total")||i.includes("nombre")||/^[=]/.test(s)||o.push({id:null,nombre:s,dni:t.idxDni>=0?String(n[t.idxDni]||"").trim():"",correo:t.idxCorreo>=0?String(n[t.idxCorreo]||"").trim():"",fecha:t.idxNac>=0?String(n[t.idxNac]||"").trim():"",cel:t.idxCel>=0?String(n[t.idxCel]||"").trim():"",edad:t.idxEdad>=0?String(n[t.idxEdad]||"").trim():""})}return o}function yo(e,t){let o=0,a=0;const n=e.alumnos.find(s=>ae(s.nombre)===ae(t.nombre));if(n)!n.dni&&t.dni&&(n.dni=t.dni,o++),!n.correo&&t.correo&&(n.correo=t.correo,o++),!n.cel&&t.cel&&(n.cel=t.cel,o++),!n.fecha&&t.fecha&&(n.fecha=t.fecha,o++),!n.edad&&t.edad&&(n.edad=t.edad,o++);else{const s=Be(e);e.alumnos.push({...t,id:s}),e.asistencias[s]={},a++}return{actualizados:o,agregados:a}}function xo(e,t){let o=0,a=0,n=!1;return t.forEach(s=>{const i=k(s);let r=0,l=0;e.forEach(d=>{const c=yo(i,d);r+=c.agregados,l+=c.actualizados}),(r>0||l>0)&&($e(i),o+=r,a+=l,n=!0,T===s&&R(s))}),{totalAgregados:o,totalActualizados:a,needsSave:n}}async function Qe(e=!1){const t=_.find(n=>n.id==="tics_sabados");if(!t||!t.googleSheetCsvUrl)return;const o=["tics_S_1","tics_S_2","tics_S_3","tics_S_4"],a=t.googleSheetCsvUrl;try{const n=await fetch(a);if(!n.ok)throw new Error(`HTTP ${n.status}`);const s=await n.text(),i=Tt(s.replaceAll(`\r
`,`
`).replaceAll("\r",`
`)),r=bo(i);if(!r.length){e&&p("📋 El Sheet aún no tiene alumnos con datos");return}const{totalAgregados:l,totalActualizados:d,needsSave:c}=xo(r,o);c?(z(),T==="dashboard"&&He(),e&&p(`✅ Sábados: ${l} inserciones, ${d} actualizaciones (total 4 módulos)`),typeof Q=="function"&&l>0&&Q("📅",`${l} inserciones de alumnos sincronizadas`,"Sábados M1-M4")):e&&p("✓ Sábados: sin cambios nuevos")}catch(n){e&&p("⚠️ Error al leer el Sheet de sábados: "+n.message),console.warn("[syncSheetTicsSabados]",n)}}setTimeout(()=>Qe(!1),2e3);setInterval(()=>Qe(!1),5*60*1e3);function $o(e){if(e==="dashboard")return"Resumen General";if(e==="personalizados")return"👤 Clases Personalizadas";if(e==="mensual")return"📅 Resumen Mensual";if(e==="historial")return"🕒 Historial de Cambios";if(e==="admin_carreras")return"⚙️ Gestión de Carreras";if(e==="horas"){const o=_.find(a=>a.id===$);return`🕐 Registro de Horas — ${(o==null?void 0:o.nombre)||""}`}if(e.startsWith("carrera_")){const o=e.split("carrera_")[1],a=_.find(n=>n.id===o);if(a)return`${a.icono} ${a.nombre} — Panel de Carrera`}const t=F(e);return t?`${t.seccion.label} — ${t.carrera.nombre}`:"Resumen General"}function Eo(e){if(e==="dashboard")He();else if(e==="personalizados")ve();else if(e==="mensual"){const t=document.getElementById("mensualMes");t&&!t.value&&(t.value=U.slice(0,7))}else if(e!=="historial"){if(e==="admin_carreras")xt();else if(e==="horas")wt(),ge();else if(!e.startsWith("carrera_")){const t=new Date().toISOString().split("T")[0],o=document.getElementById(`date-${e}`);o&&o.value!==t&&(o.value===U||o.value==="")&&(o.value=t),R(e),setTimeout(()=>jo(e),50)}}}function ze(e){var t;document.querySelectorAll(".page").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(o=>o.classList.remove("active")),(t=document.getElementById(`page-${e}`))==null||t.classList.add("active"),document.querySelectorAll(".nav-item").forEach(o=>{o.getAttribute("onclick")===`goPage('${e}')`&&o.classList.add("active")}),T=e,document.getElementById("topbarTitle").textContent=$o(e),window.innerWidth<900&&(document.getElementById("sidebar").classList.add("hidden"),document.getElementById("sidebarOverlay").classList.remove("show")),Eo(e)}function Ye(){const e=_.find(n=>n.id===$);if(!e)return;const t=document.getElementById("logoMark");t&&(t.textContent=e.nombre);const o=document.getElementById("carrerasList");o&&(o.innerHTML=_.map(n=>`
          ...
          </div>`).join(""),o.innerHTML+='<button class="btn-nueva-carrera" onclick="showAddCarreraModal()">➕ Nueva Carrera</button>');const a=document.getElementById("mensualKey");a&&(a.innerHTML=_.flatMap(n=>n.secciones.map(s=>`<option value="${s.id}">${n.icono} ${s.label}</option>`)).join("")),document.querySelectorAll(".nav-item").forEach(n=>{n.classList.toggle("active",n.getAttribute("onclick")===`goPage('${T}')`)})}function So(e){if(e===$){const t=document.getElementById("cb-"+e);t&&t.classList.toggle("carrera-active");return}_t(e)}function wo(e,t){e!==$&&($=e,localStorage.setItem("currentGrupo",e)),ze(t),Ye()}function _t(e){if(e===$)return;$=e,localStorage.setItem("currentGrupo",e),Ye(),!me(e).includes(T)&&T!=="dashboard"&&T!=="personalizados"&&T!=="mensual"&&T!=="historial"&&T!=="horas"&&T!=="admin_carreras"&&!T.startsWith("carrera_")?ze("dashboard"):T==="dashboard"&&He()}async function Io(e,t){if(!t)return{alumnos:[],retirados:[],asistencias:{},fechas:[],motivos:{},notas:{},participacion:{}};const o=t.asistencias||{},a=t.fechas||[],n=(t.alumnos||[]).map(r=>({...r,id:Number(r.id)||r.id})),s=(t.retirados||[]).map(r=>({...r,id:Number(r.id)||r.id})),i={};return Object.entries(o).forEach(([r,l])=>{const d=isNaN(r)?r:Number(r);i[d]=l}),{alumnos:n,retirados:s,asistencias:i,fechas:a,motivos:t.motivos||{},notas:t.notas||{},participacion:t.participacion||{},emptiedAt:t.emptiedAt||null,updatedAt:t.updatedAt||null}}function _o(e,t,o,a){g[e]={alumnos:[],retirados:o.retirados||t.retirados||[],asistencias:{},fechas:[],motivos:{},notas:{},participacion:{}},a&&!ie[e]&&(ie[e]=Date.now(),nt()),z()}function Mo(e,t,o){g[e]={alumnos:t.alumnos||o.alumnos||[],retirados:t.retirados||o.retirados||[],asistencias:{...o.asistencias||{},...t.asistencias||{}},fechas:[...new Set([...t.fechas||[],...o.fechas||[]])].sort(),motivos:{...t.motivos||{},...o.motivos||{}},notas:an(t.notas,o.notas),participacion:{...t.participacion||{},...o.participacion||{}}},sn(),z()}async function Co(e,t,o,a){if(Fe()){const n=document.getElementById("fbLoaderOverlay");n&&(n.style.display="flex");try{const s=await K.collection("modulos").doc(a).get();if(s.exists){let i=s.data();if(i._chunked===!0){const[c,u,m]=await Promise.all([K.collection("modulos").doc(a+"__alumnos").get(),K.collection("modulos").doc(a+"__asistencias").get(),K.collection("modulos").doc(a+"__extras").get()]),v=c.exists?c.data():{},f=u.exists?u.data():{},b=m.exists?m.data():{};i={...i,alumnos:v.alumnos||[],retirados:v.retirados||[],asistencias:f.asistencias||{},motivos:b.motivos||{},notas:b.notas||{},participacion:b.participacion||{}}}const r=await Io(a,i),l=k(a),d=r.emptiedAt&&(r.alumnos||[]).length===0;nn(a,r,!0)?_o(a,r,l,d):Mo(a,r,l)}}catch(s){p("⚠️ No se pudo descargar datos a tiempo: "+s.message)}finally{n&&(n.style.display="none")}}ze(a)}function Ao(e){const t={};e.secciones.forEach(a=>{let n="General";const s=a.label.toLowerCase();if(s.includes("módulo 1"))n="Módulo 1";else if(s.includes("módulo 2"))n="Módulo 2";else if(s.includes("módulo 3"))n="Módulo 3";else if(s.includes("módulo 4"))n="Módulo 4";else if(s.includes("módulo")){const i=s.match(/módulo\s*\d+/i);i&&(n=i[0].replace(/^m/i,"M"))}else n=a.label.includes("-")?a.label.split("-")[1].trim():a.label;t[n]||(t[n]=[]),t[n].push(a)});const o=Object.keys(t).map(a=>{let s=t[a].map(i=>{let r=i.label.includes("-")?i.label.split("-")[0].trim():i.badge;return r.toLowerCase().includes("mañana")?r="☀️ "+r:r.toLowerCase().includes("tarde")&&(r="🌙 "+r),`<button class="pill-btn" onclick="cargarAsistencia('${e.id}', '${a}', '${r}', '${i.id}')">${r}</button>`}).join("");return`
          <div class="mod-card">
      ...
      `}function To(e){const t=F(e);if(!t)return"";const o=t.seccion;return`
  ...
  <div style="margin-top:20px">
  ...
  </div>`}function Bo(e,t){const o=t.files[0];if(!o)return;const a=new FileReader;a.onload=n=>{const s=XLSX.read(n.target.result,{type:"binary",cellDates:!0}),i=s.Sheets[s.SheetNames[0]],r=XLSX.utils.sheet_to_json(i,{header:1,defval:""}),l=Mt(r);if(!l){p("❌ No se pudieron leer los datos del archivo.");return}g[e]=l,R(e),p(`✅ ${l.alumnos.length} alumnos importados en ${e.replace("-"," Módulo ")}`),t.value=""},a.readAsBinaryString(o)}function No(e){const t={};for(let a=1;a<e.length;a++){const n=e[a];let s=null;n instanceof Date?s=n.toISOString().split("T")[0]:n!==""&&n!==null&&(s=Lo(String(n).trim())),s&&(t[a]=s)}const o=[...new Set(Object.values(t))].sort();return{dateColMap:t,fechas:o}}function Po(e,t){const o=[],a={};for(let n=2;n<e.length;n++){const s=e[n],i=String(s[0]||"").trim();if(!i||i.length<2)continue;const r=i.toLowerCase();if(r.includes("total")||r.includes("nombre")||r.includes("alumno")||/^[=]/.test(i)||String(s[1]||"").startsWith("="))continue;const l=n;o.push({id:l,nombre:i}),a[l]={};for(const[d,c]of Object.entries(t)){const u=String(s[d]||"").trim();(u==="Presente"||u==="Falta"||u==="Permiso")&&(a[l][c]=u)}}return{alumnos:o,asistencias:a}}function Mt(e){if(!e||e.length<3)return null;const{dateColMap:t,fechas:o}=No(e[0]),{alumnos:a,asistencias:n}=Po(e,t);return a.length===0?null:(a.sort((s,i)=>s.nombre.localeCompare(i.nombre,"es",{sensitivity:"base"})),{alumnos:a,asistencias:n,fechas:o})}function Lo(e){if(/^\d{4}[-\/]\d{1,2}[-\/]\d{1,2}$/.test(e)){const o=e.replace(/\//g,"-").split("-");return`${o[0]}-${o[1].padStart(2,"0")}-${o[2].padStart(2,"0")}`}if(/^\d{1,2}[-\/]\d{1,2}[-\/]\d{4}$/.test(e)){const o=e.split(/[-\/]/);return`${o[2]}-${o[1].padStart(2,"0")}-${o[0].padStart(2,"0")}`}const t=Number(e);return!isNaN(t)&&t>4e4&&t<6e4?new Date((t-25569)*86400*1e3).toISOString().split("T")[0]:null}let se=JSON.parse(localStorage.getItem("google_sheets_sync")||"{}"),we={};function Ze(){localStorage.setItem("google_sheets_sync",JSON.stringify(se))}function Fo(e){const t=(e==null?void 0:e.googleSheetsSync)||(e==null?void 0:e.googleSheetsSyncConfig)||(e==null?void 0:e.google_sheets_sync);if(!t||typeof t!="object")return 0;let o=0;return Object.entries(t).forEach(([a,n])=>{var s;!a||!n||typeof n!="object"||(se[a]={...se[a]||{},...n},o++,(s=se[a])!=null&&s.autoSync&&ke(a))}),o>0&&Ze(),o}async function Oo(e,t){const o=`https://sheets.googleapis.com/v4/spreadsheets/${e}/values/Sheet1?key=${t}`,a=await fetch(o);if(!a.ok)throw new Error("Error al conectar con Google Sheets");const n=await a.json();if(!n.values||n.values.length===0)throw new Error("Hoja vacía");return n.values}function zo(e){return Mt(e)}function Ct(e){const t=se[e]||{};pe();const o=`
    ...
    <div id="gsSyncStatus" style="margin-top:12px;font-size:.78rem;color:var(--muted)"></div>`;C("📊 Sincronizar con Google Sheets","",()=>{var r,l,d,c;const a=(r=document.getElementById("gsSheetId"))==null?void 0:r.value.trim(),n=(l=document.getElementById("gsApiKey"))==null?void 0:l.value.trim(),s=(d=document.getElementById("gsCsvUrl"))==null?void 0:d.value.trim(),i=(c=document.getElementById("gsAutoSync"))==null?void 0:c.checked;if(!a&&!s){p("⚠️ Ingresa el ID del Sheet o URL CSV");return}se[e]={sheetId:a,apiKey:n,csvUrl:s,autoSync:i},Ze(),i?ke(e):Bt(e),w(),p("✅ Configuración guardada")},o)}async function At(e){const t=se[e];if(!t){p("⚠️ Configura la conexión primero"),Ct(e);return}p("⏳ Importando desde Google Sheets...");try{let o;if(t.csvUrl){const l=await fetch(t.csvUrl);if(!l.ok)throw new Error("CSV no accesible");const c=(await l.text()).replace(/\r\n/g,`
`).replace(/\r/g,`
`);o=Tt(c)}else if(t.sheetId&&t.apiKey)o=await Oo(t.sheetId,t.apiKey);else throw new Error("Configuración incompleta");const a=zo(o);if(!a){p("❌ No se pudieron parsear los datos");return}const n=g[e],s=[...(n==null?void 0:n.alumnos)||[]],i={...(n==null?void 0:n.asistencias)||{}};a.alumnos.forEach(l=>{const d=s.findIndex(c=>c.nombre.trim().toLowerCase()===l.nombre.trim().toLowerCase());if(d===-1){const c=Be({alumnos:s,retirados:(n==null?void 0:n.retirados)||[]});s.push({...l,id:c}),i[c]=a.asistencias[l.id]||{}}else{const c=s[d].id;i[c]={...i[c],...a.asistencias[l.id]}}});const r=[...new Set([...(n==null?void 0:n.fechas)||[],...a.fechas])].sort();g[e]={...g[e],alumnos:s.sort((l,d)=>l.nombre.localeCompare(d.nombre,"es",{sensitivity:"base"})),asistencias:i,fechas:r,motivos:{...(n==null?void 0:n.motivos)||{},...a.motivos||{}},notas:{...(n==null?void 0:n.notas)||{},...a.notas||{}},participacion:{...(n==null?void 0:n.participacion)||{},...a.participacion||{}}},z(),R(e),p(`✅ ${a.alumnos.length} alumnos importados. Total: ${s.length}`)}catch(o){p(`❌ Error: ${o.message}`)}}function Tt(e){const t=[];let o=[],a="",n=!1;for(let s=0;s<e.length;s++){const i=e[s],r=e[s+1];n?i==='"'&&r==='"'?(a+='"',s++):i==='"'?n=!1:a+=i:i==='"'?n=!0:i===","?(o.push(a.trim()),a=""):i===`
`?(o.push(a.trim()),o.some(l=>l)&&t.push(o),o=[],a=""):a+=i}return(a||o.length>0)&&(o.push(a.trim()),o.some(s=>s)&&t.push(o)),t}function ke(e){Bt(e),we[e]=setInterval(()=>{const t=se[e];t!=null&&t.autoSync&&At(e)},5*60*1e3)}function Bt(e){if(e){we[e]&&(clearInterval(we[e]),delete we[e]);return}Object.values(we).forEach(t=>clearInterval(t)),we={}}function gt(){Object.keys(se||{}).forEach(e=>{var t;(t=se[e])!=null&&t.autoSync&&(At(e),ke(e))})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",gt,{once:!0}):gt();function Ho(e,t,o,a){const n=t.asistencias[e.id]||{},s=n[o]||"",i=t.fechas.filter(v=>v!==o).slice(-15);let r=0,l=0;Object.values(n).forEach(v=>{v==="Falta"?r++:(v==="Presente"||v==="Permiso")&&l++});const d=t.fechas.filter(v=>v<=o).length,c=d>0?Math.round(l/d*100):0,u=r>=a,m=c>=80?"var(--green)":c>=60?"var(--yellow)":"var(--red)";return{hoy:s,hist:i,totalF:r,pct:c,enAlerta:u,barCol:m,reg:n}}function Do(e,t,o,a,n,s){const{hoy:i,hist:r,totalF:l,pct:d,enAlerta:c,barCol:u,reg:m}=s,v=o.motivos&&o.motivos[e.id]&&o.motivos[e.id][a]||null,f=!!(e.dni||e.cel||e.correo||e.edad);let b="";const h=e.nombre.replaceAll("'","\\'");i==="Falta"&&(e.cel&&(b+=`<button onclick="enviarWhatsApp('${h}','${e.cel}','${n}','${a}')" style="background:#25D366;color:#fff;border:none;border-radius:6px;padding:3px 8px;font-size:.72rem;cursor:pointer;font-weight:600">📱 WA</button>`),e.correo&&(b+=`<button onclick="enviarCorreo('${h}','${e.correo}','${n}','${a}')" style="background:var(--sky);color:#000;border:none;border-radius:6px;padding:3px 8px;font-size:.72rem;cursor:pointer;font-weight:600">✉️</button>`));const y=r.map(x=>{var M,H;const E=m[x]||"none",D=(H=(M=o.motivos)==null?void 0:M[e.id])==null?void 0:H[x];return`<div class="hd ${E}" title="${x}: ${E}${D?`
📎 `+D.texto:""}" style="${D?"box-shadow:0 0 0 1.5px var(--amber)":""}"></div>`}).join("");return`
      ...
      </td>`}function R(e){var v,f,b;const t=k(e),o=((v=document.getElementById(`date-${e}`))==null?void 0:v.value)||U,a=(((f=document.getElementById(`search-${e}`))==null?void 0:f.value)||"").toLowerCase(),n=Number.parseInt(((b=document.getElementById(`thr-${e}`))==null?void 0:b.value)||3),s=t.alumnos.filter(h=>h.nombre.toLowerCase().includes(a));t.alumnos.length>0&&!t.fechas.includes(o)&&t.alumnos.some(y=>(t.asistencias[y.id]||{})[o])&&(t.fechas.push(o),t.fechas.sort()),document.getElementById(`modTitle-${e}`).textContent=`${t.alumnos.length} alumno(s) registrado(s)`;let i=0,r=0,l=0,d=0;const c=document.getElementById(`tbody-${e}`);if(!c)return;c.innerHTML="",s.length===0&&(c.innerHTML=`<tr><td colspan="6"><div class="empty"><div class="ei">${t.alumnos.length===0?"📋":"🔍"}</div>${t.alumnos.length===0?"Sin alumnos. Importa un Excel o agrega manualmente.":"Sin resultados."}</div></td></tr>`),s.forEach((h,y)=>{const x=Ho(h,t,o,n);x.hoy==="Presente"?i++:x.hoy==="Falta"?r++:x.hoy==="Permiso"&&l++,x.enAlerta&&d++;const E=document.createElement("tr");E.innerHTML=Do(h,y,t,o,e,x),c.appendChild(E)}),document.getElementById(`st-pres-${e}`).textContent=i,document.getElementById(`st-falt-${e}`).textContent=r,document.getElementById(`st-perm-${e}`).textContent=l,document.getElementById(`st-alert-${e}`).textContent=d;const u=t.alumnos.filter(h=>Object.values(t.asistencias[h.id]||{}).filter(y=>y==="Falta").length>=n),m=document.getElementById(`alertBar-${e}`);u.length>0?(m.classList.add("show"),document.getElementById(`alertTxt-${e}`).innerHTML=`<strong>${u.length} alumno(s) con ${n}+ faltas:</strong> ${u.map(h=>h.nombre.split(" ")[0]).join(", ")}`):m.classList.remove("show"),un(e),Xo(e),Pe(e),it(e)}function Ro(e,t){const o=document.getElementById(`date-${e}`);if(o){if(t==="hoy")o.value=U;else if(t==="ayer"){const a=new Date;a.setDate(a.getDate()-1),o.value=a.toISOString().split("T")[0]}Nt(e)}}function Nt(e){R(e),Pt(e)}function Pt(e){const t=document.getElementById(`date-${e}`);if(!t)return;const o=t.value,a=document.getElementById(`dateInfo-${e}`),n=document.getElementById(`btnHoy-${e}`),s=document.getElementById(`btnAyer-${e}`),i=document.getElementById(`th-asist-${e}`),r=new Date;r.setDate(r.getDate()-1);const l=r.toISOString().split("T")[0];if(n&&n.classList.toggle("active",o===U),s&&s.classList.toggle("active",o===l),a)if(o===U)a.textContent="📅 Hoy",a.className="date-selector-info hoy";else{const[d,c,u]=o.split("-"),m=`${u}/${c}/${d}`;a.textContent=`📆 Fecha pasada: ${m}`,a.className="date-selector-info pasado"}if(i)if(o===U)i.textContent="Asistencia hoy";else{const[d,c,u]=o.split("-");i.textContent=`Asistencia ${u}/${c}/${d}`}}function jo(e){Pt(e)}function Go(e,t,o,a){var i,r,l,d;const n=g[e];if(n.asistencias[t]||(n.asistencias[t]={}),n.asistencias[t][o]===a?(delete n.asistencias[t][o],(r=(i=n.motivos)==null?void 0:i[t])!=null&&r[o]&&delete n.motivos[t][o],a=""):(n.asistencias[t][o]=a,a==="Presente"&&((d=(l=n.motivos)==null?void 0:l[t])!=null&&d[o])&&delete n.motivos[t][o],n.fechas.includes(o)||(n.fechas.push(o),n.fechas.sort())),R(e),z(),Te(e),Lt(e,t),a==="Presente"||a==="Falta"||a==="Permiso"){const c=!P.some(u=>u._uid===`mod_${e}_${o}`);Jo(),c&&typeof Je=="function"&&Je(e,o)}const s=n.alumnos.find(c=>c.id===t)||(n.retirados||[]).find(c=>c.id===t);if(s&&typeof Q=="function"){const c=e.replace("M-","Mañana M").replace("T-","Tarde M"),u={Presente:"✅",Falta:"❌",Permiso:"🔵","":"↩️"},m={Presente:"Presente",Falta:"Falta",Permiso:"Permiso","":"eliminada"};Q(u[a]||"📝",`${s.nombre} — ${m[a]||a}`,`${c} · ${o}`)}}function Jo(e,t){et(!1)}function et(e=!0,t=!0){const o=["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"],a=pe();let n=0;if(P=P.filter(s=>!(s._tipo==="modulo"&&(!s.curso||s.curso.includes("undefined")))),P.forEach(s=>{if(s._tipo==="modulo"&&s._key){const i=F(s._key);i&&s._grupo!==i.carrera.id&&(s._grupo=i.carrera.id),i&&(!s.curso||s.curso.includes("undefined"))&&(s.curso=i.seccion.label)}}),P=P.filter(s=>{if(s._tipo==="modulo"){const i=g[s._key];return!!i&&(i.fechas||[]).includes(s.fecha)}if(s._tipo==="personalizado"){const i=B.find(r=>String(r.id)===String(s._pid));return i?(i.clases||[]).some(r=>r.fecha===s.fecha):!0}return!0}),a.forEach(s=>{const i=g[s];if(!i)return;const r=F(s),l=r?r.seccion.label:s,d=r?r.carrera.id:$;(i.alumnos||[]).length;const c=s.includes("_M_")||l.toLowerCase().includes("mañana"),u=s.includes("_T_")||l.toLowerCase().includes("tarde");let m,v,f;if(c)m="09:00",v="13:00",f=4;else if(u)m="14:00",v="18:00",f=4;else{const b=P.find(h=>h._key===s&&h.entrada&&h.salida);b?(m=b.entrada,v=b.salida,f=Ge(b.entrada,b.salida)||2):(m="11:00",v="13:00",f=2)}(i.fechas||[]).forEach(b=>{const h=`mod_${s}_${b}`,y=(i.alumnos||[]).filter(D=>{var H,q;const M=((q=(H=i.asistencias)==null?void 0:H[D.id])==null?void 0:q[b])||"";return M!==""&&M!=="Falta"}).length,x=P.findIndex(D=>D._uid===h);if(x>=0){P[x].alumnos=y;return}const E=o[new Date(b+"T12:00:00").getDay()];P.push({id:Date.now()+Math.random(),_uid:h,_tipo:"modulo",_grupo:d,_key:s,dia:E,fecha:b,curso:l,tema:"",entrada:m,salida:v,horas:f,alumnos:y,obsv:"Presencial"}),n++})}),B.forEach(s=>{(s.clases||[]).forEach(i=>{if(!i.horas&&!i.horaInicio)return;const r=`pers_${s.id}_${i.fecha}`;if(P.some(u=>u._uid===r))return;const d=o[new Date(i.fecha+"T12:00:00").getDay()];let c=0;i.horas?c=Number.parseFloat(i.horas):i.horaInicio&&i.horaFin&&(c=Ge(i.horaInicio,i.horaFin)),P.push({id:Date.now()+Math.random(),_uid:r,_tipo:"personalizado",_pid:s.id,dia:d,fecha:i.fecha,curso:s.nombre,tema:"",entrada:i.horaInicio||"",salida:i.horaFin||"",horas:c||1,alumnos:1,obsv:i.val||"Presente"}),n++})}),_e(),t&&T==="horas"&&ge(),e){const s=document.getElementById("horasSyncStatus");s&&(s.textContent=`✓ Sincronizado — ${n} entrada(s) nueva(s)`),n>0?p(`🔄 ${n} clase(s) importadas`):p("✓ Todo al día")}}function Wo(){const e=`
  ...
  </div>`;C(`${c} ${u?"Editar motivo":"Registrar "+a} — ${((v=d==null?void 0:d.nombre)==null?void 0:v.split(" ").slice(0,2).join(" "))||""}`,"",()=>{var x,E;const f=((x=document.getElementById("motivoTxt"))==null?void 0:x.value.trim())||"",b=(E=document.getElementById("fotoPreview"))==null?void 0:E.querySelector("img"),h=b?b.src:i.foto||"";n.asistencias[t][o]=a,n.fechas.includes(o)||(n.fechas.push(o),n.fechas.sort()),f||h?n.motivos[t][o]={texto:f,foto:h,tipo:a}:delete n.motivos[t][o],w(),R(e),z(),Te(e),Lt(e,t);let y=" registrada";f&&(y=' — "'+f.substring(0,30)+(f.length>30?"...":"")+'"'),p(`${c} ${a}${y}`)},m),document.getElementById("mOk").textContent=u?"💾 Guardar cambios":`Registrar ${a}`,setTimeout(()=>{var b;const f=document.querySelector(".modal");f&&(f.style.maxWidth="520px"),(b=document.getElementById("motivoTxt"))==null||b.focus(),globalThis._pasteFotoHandler=async h=>{var x;const y=(x=h.clipboardData)==null?void 0:x.items;if(y){for(const E of y)if(E.type.startsWith("image/")){h.preventDefault();const D=E.getAsFile(),M=new FileReader;M.onload=H=>{const q=document.getElementById("fotoPreview");if(q){q.innerHTML=`<img src="${H.target.result}" alt="evidencia">`;const re=q.parentElement;if(re&&!re.querySelector(".btn-quitar-foto")){const Y=document.createElement("button");Y.className="btn btn-red btn-quitar-foto",Y.style.cssText="font-size:.7rem;margin-top:6px;padding:3px 8px",Y.textContent="✕ Quitar foto",Y.onclick=qo,re.appendChild(Y)}}p("📷 Imagen pegada")},M.readAsDataURL(D);break}}},document.addEventListener("paste",globalThis._pasteFotoHandler)},50)}globalThis._fotoBase64="";function qo(){const e=document.getElementById("fotoPreview");e&&(e.innerHTML="📷 Clic para subir foto"),globalThis._fotoBase64=""}function Vo(e,t){const o=g[e],a=o.alumnos.find(f=>f.id===t);if(!a)return;const n=o.asistencias[a.id]||{},s=o.motivos||{},i=Object.values(n).filter(f=>f==="Presente").length,r=Object.values(n).filter(f=>f==="Falta").length,l=Object.values(n).filter(f=>f==="Permiso").length,d=o.fechas.length,c=d>0?Math.round((i+l)/d*100):0;let u="var(--red)";c>=80?u="var(--green)":c>=60&&(u="var(--yellow)");const m=o.fechas.length===0?'<div style="color:var(--muted);font-size:.8rem;text-align:center;padding:12px">Sin clases registradas</div>':o.fechas.slice().reverse().map(f=>{var E;const b=n[f]||"—",h=(E=s[a.id])==null?void 0:E[f];let y="var(--muted)";b==="Presente"?y="var(--green)":b==="Falta"?y="var(--red)":b==="Permiso"&&(y="var(--blue)");let x="";return h&&(x=`<div style="flex:1">
  ...
  <div class="retirados-section">
    ...
    <div id="${n}" style="display:none">
  ...
  </div>`}function Ko(e,t){const o=g[e],a=o.alumnos.find(r=>r.id===t);if(!a)return;const{prefix:n,num:s,isLegacy:i}=Me(e);C("📤 Retirar alumno",`¿Confirmas retirar a "${a.nombre}"? Se retirará en este módulo y en los siguientes del mismo turno.`,async()=>{const r=[e];o.alumnos=o.alumnos.filter(l=>l.id!==t),o.retirados||(o.retirados=[]),o.retirados.some(l=>Number(l.id)===Number(a.id)||ae(l.nombre)===ae(a.nombre))||o.retirados.push({...a,retirado:!0}),[2,3,4,5,6,7,8,9].forEach(l=>{if(l<=s)return;const d=i?`${n}-${l}`:`${n}_${l}`;if(!g[d])return;const c=g[d],u=c.alumnos.find(m=>m.nombre.trim().toLowerCase()===a.nombre.trim().toLowerCase());u&&(c.alumnos=c.alumnos.filter(m=>m.id!==u.id),c.retirados||(c.retirados=[]),c.retirados.some(m=>Number(m.id)===Number(u.id)||ae(m.nombre)===ae(u.nombre))||c.retirados.push({...u,retirado:!0}),r.push(d))}),z(),R(e);try{await Promise.all(r.map(l=>Xe(l)))}catch(l){console.warn("Firebase sync error on retire:",l),p("Alumno retirado localmente. Firebase se sincronizará después.")}if(w(),typeof Q=="function"){const l=e.replace("M-","Mañana M").replace("T-","Tarde M");Q("📤",`${a.nombre} retirado`,l)}p(`📤 "${a.nombre}" retirado en módulo ${s} y siguientes`)})}async function Qo(e,t){const o=g[e];if(!o)return;const a=(o.retirados||[]).findIndex(i=>i.id===t);if(a===-1)return;const n=o.retirados[a];o.retirados.splice(a,1);const s={...n};delete s.retirado,o.alumnos.push(s),$e(o),z(),R(e);try{await yt(e,s)}catch(i){p("Alumno reactivado localmente, pero no se pudo sincronizar Firebase: "+i.message);return}if(p(`♻️ "${n.nombre}" reactivado`),typeof Q=="function"){const i=e.replace("M-","Mañana M").replace("T-","Tarde M");Q("♻️",`${n.nombre} reactivado`,i)}}function Yo(e,t){const o=Number(t),a=g[e];if(!a)return;const n=a.alumnos.find(r=>Number(r.id)===o);if(!n)return;const s=pe().filter(r=>r!==e).map(r=>{const l=F(r);return`<option value="${r}">${l.carrera.nombre} - ${l.seccion.label}</option>`}).join(""),i=`
      ...
      <div class="fgroup">
        ...
        <select class="finp" id="selectDestinoMover">
      ...
      </div>`;C("🔄 Mover Alumno","",()=>{const r=document.getElementById("selectDestinoMover").value;r&&(rn(e,r,t),w())},i)}function k(e){g[e]||(g[e]={alumnos:[],retirados:[],asistencias:{},fechas:[],motivos:{},notas:{},participacion:{}});const t=g[e];return Array.isArray(t.alumnos)||(t.alumnos=[]),Array.isArray(t.retirados)||(t.retirados=[]),t.asistencias||(t.asistencias={}),Array.isArray(t.fechas)||(t.fechas=[]),t.motivos||(t.motivos={}),t.notas||(t.notas={}),t.participacion||(t.participacion={}),t}function ae(e){return String(e||"").trim().toLowerCase()}function tt(e,t){const o=String(t);return[...e.alumnos||[],...e.retirados||[]].some(a=>String(a.id)===o)}function Be(e){const t=[...e.alumnos||[],...e.retirados||[]].map(a=>Number(a.id)).filter(Number.isFinite);let o=t.length?Math.max(...t)+1:1;for(;tt(e,o);)o++;return o}function ot(e,t,o,a){const n=String(o),s=String(a),i=e.asistencias&&(e.asistencias[n]||e.asistencias[o])||{},r=e.motivos&&(e.motivos[n]||e.motivos[o])||{},l=e.participacion&&(e.participacion[n]??e.participacion[o]);t.asistencias||(t.asistencias={}),t.asistencias[s]||(t.asistencias[s]={}),Object.assign(t.asistencias[s],i);const d=new Set([...t.fechas||[],...e.fechas||[],...Object.keys(i)]);t.fechas=Array.from(d).sort((c,u)=>c.localeCompare(u)),Object.keys(r).length>0&&(t.motivos||(t.motivos={}),t.motivos[s]||(t.motivos[s]={}),Object.assign(t.motivos[s],r)),t.notas||(t.notas={}),Object.entries(e.notas||{}).forEach(([c,u])=>{var v,f;if(!u||!u.notas)return;const m=((v=u.notas)==null?void 0:v[n])??((f=u.notas)==null?void 0:f[o]);m!==void 0&&(t.notas[c]||(t.notas[c]={...u,notas:{}}),t.notas[c].notas||(t.notas[c].notas={}),t.notas[c].notas[s]=m)}),l!==void 0&&(t.participacion||(t.participacion={}),t.participacion[s]=l)}function Zo(e,t){const o=String(t);e.asistencias&&(delete e.asistencias[o],delete e.asistencias[t]),e.motivos&&(delete e.motivos[o],delete e.motivos[t]),e.participacion&&(delete e.participacion[o],delete e.participacion[t]),Object.values(e.notas||{}).forEach(a=>{a!=null&&a.notas&&(delete a.notas[o],delete a.notas[t])})}function nt(){localStorage.setItem("asist_empty_modules",JSON.stringify(ie))}function at(e){ie[e]=Date.now(),nt()}function ko(e){ie[e]&&(delete ie[e],nt())}function en(e){var t;return!!ie[e]&&(((t=g[e])==null?void 0:t.alumnos)||[]).length===0}function tn(e,t){var i;const o=((i=g[e])==null?void 0:i.alumnos)||[],a=(t==null?void 0:t.alumnos)||[];if(o.length>0||a.length===0)return!1;const n=a.map(r=>ae(r.nombre)).filter(Boolean);if(!n.length)return!1;const s=new Set;return pe().forEach(r=>{var l;r!==e&&(((l=g[r])==null?void 0:l.alumnos)||[]).forEach(d=>{const c=ae(d.nombre);c&&s.add(c)})}),n.every(r=>s.has(r))}function on(e){if(!e)return 0;if(typeof e.toMillis=="function")return e.toMillis();if(typeof e.seconds=="number")return e.seconds*1e3+Math.floor((e.nanoseconds||0)/1e6);const t=Date.parse(e);return Number.isFinite(t)?t:0}function nn(e,t,o=!0){if(o&&(t==null?void 0:t.emptiedAt)&&(t.alumnos||[]).length===0)return!0;if(!en(e))return tn(e,t)?(at(e),!0):!1;const n=((t==null?void 0:t.alumnos)||[]).length>0,s=on(t==null?void 0:t.updatedAt);return n&&s>(ie[e]||0)?(ko(e),!1):!0}function an(...e){const t={};return e.forEach(o=>{Object.entries(o||{}).forEach(([a,n])=>{if(n){if(!t[a]){t[a]={...n,notas:{...n.notas||{}}};return}t[a]={...t[a],...n,notas:{...t[a].notas||{},...n.notas||{}}}}})}),t}function sn(){let e=!1;return pe().forEach(t=>{const o=k(t),a=new Set;o.alumnos.forEach(n=>{const s=String(n.id);if(!n.id||a.has(s)){const i=n.id,r=Be(o);ot(o,o,i,r),n.id=r,e=!0}a.add(String(n.id))})}),e}function rn(e,t,o){var c;const a=Number(o),n=k(e),s=k(t),i=n.alumnos.findIndex(u=>Number(u.id)===a);if(i===-1)return;const r=n.alumnos[i],l=s.alumnos.find(u=>ae(u.nombre)===ae(r.nombre));let d=r.id;l?d=l.id:(tt(s,d)&&(d=Be(s)),s.alumnos.push({...r,id:d})),ot(n,s,r.id,d),n.alumnos.splice(i,1),Zo(n,r.id),n.alumnos.length===0&&at(e),n.alumnos.sort((u,m)=>u.nombre.localeCompare(m.nombre,"es",{sensitivity:"base"})),s.alumnos.sort((u,m)=>u.nombre.localeCompare(m.nombre,"es",{sensitivity:"base"})),z(),V(e),V(t),R(e),p(`✅ ${r.nombre} transferido exitosamente.`),typeof Q=="function"&&Q("🔄",`${r.nombre} transferido a otra sección`,((c=F(t))==null?void 0:c.seccion.label)||t)}function We(e){const t=e.match(/_([MmTtLl])_(\d+)$/);return t?Number.parseInt(t[2]):null}function ln(e,t){const o=We(e);if(o!==3&&o!==4)return null;const a=o===3?4:3,n=e.replace(/_([MmTtLl])_(\d+)$/,`_$1_${a}`),s=We(t);let i;if(s===null)return i=t,null;let r=a;return s===3?r=4:s===4&&(r=3),i=t.replace(/_([MmTtLl])_(\d+)$/,`_$1_${r}`),!g[n]||(g[n].alumnos||[]).length===0||!F(i)?null:{origenPar:n,destinoPar:i}}function vt(e,t){const o=k(e),a=k(t),n=[...o.alumnos];let s=0,i=0,r=0;return n.forEach(l=>{const d=a.alumnos.find(u=>ae(u.nombre)===ae(l.nombre));let c=l.id;d?(c=d.id,i++):(tt(a,c)&&(c=Be(a),r++),a.alumnos.push({...l,id:c}),s++),ot(o,a,l.id,c)}),$e(a),o.alumnos=[],o.fechas=[],o.asistencias={},o.notas&&(o.notas={}),o.motivos&&(o.motivos={}),o.participacion&&(o.participacion={}),at(e),{movidos:s,duplicados:i,idsReasignados:r}}function cn(e,t){var c,u;const o=F(e),a=F(t);if((((c=g[e])==null?void 0:c.alumnos)||[]).length===0){p("⚠️ El módulo origen no tiene alumnos.");return}const{movidos:s,duplicados:i,idsReasignados:r}=vt(e,t);z(),V(e),V(t),T===e&&R(e),T===t&&R(t),typeof Q=="function"&&Q("📦",`Módulo completo movido: ${(o==null?void 0:o.seccion.label)||e} → ${(a==null?void 0:a.seccion.label)||t}`,`${s} alumno(s)`);let l=`📦 ${s} alumno(s) movido(s)`;i>0&&(l+=` · ${i} ya existía(n)`),r>0&&(l+=` · ${r} ID(s) ajustado(s)`),p(l),w();const d=ln(e,t);if(d){const m=F(d.origenPar),v=F(d.destinoPar),f=(((u=g[d.origenPar])==null?void 0:u.alumnos)||[]).length;if(f>0){const b=We(d.origenPar);setTimeout(()=>{C("📦 Mover módulo par también","",()=>{const h=vt(d.origenPar,d.destinoPar);z(),V(d.origenPar),V(d.destinoPar),T===d.origenPar&&R(d.origenPar),T===d.destinoPar&&R(d.destinoPar),typeof Q=="function"&&Q("📦",`Módulo par movido: ${(m==null?void 0:m.seccion.label)||d.origenPar} → ${(v==null?void 0:v.seccion.label)||d.destinoPar}`,`${h.movidos} alumno(s)`);let y=`📦 M${b}: ${h.movidos} alumno(s) movido(s)`;h.duplicados>0&&(y+=` · ${h.duplicados} ya existía(n)`),h.idsReasignados>0&&(y+=` · ${h.idsReasignados} ID(s) ajustado(s)`),p(y),w()},`<div style="font-size:.88rem;line-height:1.65;color:var(--text)">
          ...
          </div>`),document.getElementById("mOk").textContent="📦 Sí, mover también"},120)}}}function dn(e){var s;const t=F(e),o=(((s=g[e])==null?void 0:s.alumnos)||[]).length;if(o===0){p("⚠️ Este módulo no tiene alumnos para mover.");return}const a=pe().filter(i=>i!==e).map(i=>{const r=F(i);return`<option value="${i}">${r.carrera.nombre} — ${r.seccion.label}</option>`}).join(""),n=`
    ...
    </div>`}).join("")+"</div>"}function mn(e,t){const o=g[e];if(!o||!t)return;const[a,n,s]=t.split("-"),i=s&&n&&a?`${s}/${n}/${a}`:t;C("Quitar fecha",`¿Deseas quitar la fecha ${i}? Se eliminarán las asistencias registradas ese día en este módulo.`,async()=>{o.fechas=(o.fechas||[]).filter(r=>r!==t),Object.values(o.asistencias||{}).forEach(r=>{r&&delete r[t]}),Object.values(o.motivos||{}).forEach(r=>{r&&delete r[t]}),z(),R(e);try{await Xe(e)}catch(r){p("Fecha quitada localmente, pero no se pudo sincronizar Firebase: "+r.message);return}w(),p(`Fecha ${i} quitada`)})}function Lt(e,t){var i;const o=g[e],a=o.alumnos.find(r=>r.id===t);if(!a)return;const n=Number.parseInt(((i=document.getElementById(`thr-${e}`))==null?void 0:i.value)||"3"),s=Object.values(o.asistencias[t]||{}).filter(r=>r==="Falta").length;s===n&&a.correo&&p(`⚠️ ${a.nombre} alcanzó ${s} faltas`)}function pn(e,t){var n;const o=g[e],a=((n=document.getElementById(`date-${e}`))==null?void 0:n.value)||U;o.alumnos.forEach(s=>{o.asistencias[s.id]||(o.asistencias[s.id]={}),o.asistencias[s.id][a]=t,Te(e,s.id)}),o.fechas.includes(a)||(o.fechas.push(a),o.fechas.sort()),z(),Te(e),R(e),p("✅ Todos marcados como Presente")}function fn(e,t){const o=g[e].alumnos.find(l=>l.id===t),{prefix:a,num:n,isLegacy:s}=Me(e),i=n===1,r=i?`¿Seguro que deseas eliminar a "${o==null?void 0:o.nombre}"? Se eliminará también de los demás módulos del mismo turno.`:`¿Seguro que deseas eliminar a "${o==null?void 0:o.nombre}" de este módulo?`;C("Eliminar alumno",r,()=>{const l=g[e];l.alumnos=l.alumnos.filter(d=>d.id!==t),delete l.asistencias[t],i&&o&&[2,3,4,5,6,7,8,9].forEach(d=>{const c=s?`${a}-${d}`:`${a}_${d}`;g[c]&&(g[c].alumnos=g[c].alumnos.filter(u=>u.nombre.trim().toLowerCase()!==o.nombre.trim().toLowerCase()))}),w(),z(),R(e),p(i?"✅ Alumno eliminado de todos los módulos":"✅ Alumno eliminado"),V(),o!=null&&o.fila&&Xe(e,o.fila,o.nombre)})}function gn(e){var d;const{prefix:t,num:o,isLegacy:a}=Me(e),n=g[e];if(!((d=n==null?void 0:n.alumnos)!=null&&d.length)){p("⚠️ Este módulo no tiene alumnos");return}const s=me($),i=[2,3,4,5,6,7,8,9].filter(c=>c>o).filter(c=>{const u=a?`${t}-${c}`:`${t}_${c}`;return s.includes(u)});let r=0;const l=[];i.forEach(c=>{const u=a?`${t}-${c}`:`${t}_${c}`,m=g[u];if(!m)return;let v=0;n.alumnos.forEach(f=>{m.alumnos.some(h=>h.nombre.trim().toLowerCase()===f.nombre.trim().toLowerCase())||(m.alumnos.push({...f}),m.asistencias[f.id]||(m.asistencias[f.id]={}),v++)}),v>0?($e(m),V(u),l.push(`M${c}: ${v} alumno(s)`),r+=v):l.push(`M${c}: ya sincronizado`)}),z(),r>0?p(`✅ ${l.join(" · ")}`):p("✓ Todos los módulos siguientes ya estaban sincronizados")}function vn(e){const t=F(e),o=t?`${t.seccion.label} — ${t.carrera.nombre}`:e;C(`➕ Agregar alumno — ${o}`,"",()=>{var m,v,f,b,h,y;const a=(m=document.getElementById("addNombreInp"))==null?void 0:m.value.trim();if(!a){p("⚠️ Escribe el nombre");return}const n=g[e],s=Date.now();n.alumnos.push({id:s,nombre:a,dni:((v=document.getElementById("addDniInp"))==null?void 0:v.value.trim())||"",fecha:((f=document.getElementById("addFechaInp"))==null?void 0:f.value)||"",edad:((b=document.getElementById("addEdadInp"))==null?void 0:b.value.trim())||"",correo:((h=document.getElementById("addCorreoInp"))==null?void 0:h.value.trim())||"",cel:((y=document.getElementById("addCelInp"))==null?void 0:y.value.trim())||""}),n.asistencias[s]={},$e(n);const i=n.alumnos.find(x=>x.id===s),{prefix:r,num:l,isLegacy:d}=Me(e),c=[];[2,3,4,5,6,7,8,9].filter(x=>x>l).forEach(x=>{const E=d?`${r}-${x}`:`${r}_${x}`,D=g[E];if(!D)return;D.alumnos.some(H=>H.nombre.trim().toLowerCase()===a.toLowerCase())||(D.alumnos.push({...i}),D.asistencias[s]={},$e(D),c.push("M"+x),V(E))}),w(),R(e);const u=c.length?` · copiado a ${c.join(", ")}`:"";p(`✅ "${a}" agregado${u}`),yt(e)},`<div class="form-grid" style="margin-top:4px">
    ...
    </div>`),setTimeout(()=>{var a;return(a=document.getElementById("addNombreInp"))==null?void 0:a.focus()},100)}function hn(e,t){const o=Number(t),a=g[e],n=a.alumnos.find(i=>i.id===o);if(!n)return;const s=`
    ...
    </div>`;C(`✏️ Editar datos — ${n.nombre.split(" ").slice(0,2).join(" ")}`,"",()=>{var r,l,d,c,u,m;const i=(r=document.getElementById("edNombreInp"))==null?void 0:r.value.trim();if(!i){p("⚠️ El nombre es obligatorio");return}n.nombre=i,n.dni=((l=document.getElementById("edDniInp"))==null?void 0:l.value.trim())||"",n.edad=((d=document.getElementById("edEdadInp"))==null?void 0:d.value.trim())||"",n.fecha=((c=document.getElementById("edFechaInp"))==null?void 0:c.value)||"",n.cel=((u=document.getElementById("edCelInp"))==null?void 0:u.value.trim())||"",n.correo=((m=document.getElementById("edCorreoInp"))==null?void 0:m.value.trim())||"",$e(a),w(),R(e),z(),V(e),p(`✅ Datos de "${i}" actualizados`)},s),document.getElementById("mOk").textContent="💾 Guardar cambios",setTimeout(()=>{var i;return(i=document.getElementById("edNombreInp"))==null?void 0:i.focus()},100)}function $e(e){e.alumnos.sort((t,o)=>t.nombre.localeCompare(o.nombre,"es",{sensitivity:"base"}))}function bn(){const e=document.getElementById("pNombre").value.trim(),t=document.getElementById("pTel").value.trim();if(!e){p("⚠️ El nombre es obligatorio");return}if(!t){p("⚠️ El celular es obligatorio");return}const o={id:Date.now(),nombre:e,tel:t,clases:[]};B.push(o),B.sort((a,n)=>a.nombre.localeCompare(n.nombre,"es",{sensitivity:"base"})),["pNombre","pTel"].forEach(a=>{const n=document.getElementById(a);n&&(n.value="")}),ve(),p(`✅ "${e}" agregado`),Ee()}function Ft(e,t,o,a,n,s){const i=B.find(l=>l.id===e);if(!i)return;const r=i.clases.findIndex(l=>l.fecha===t);r>=0&&i.clases[r].val===o&&!a?i.clases.splice(r,1):r>=0?i.clases[r]={fecha:t,val:o,horas:a||i.clases[r].horas||"",horaInicio:n||i.clases[r].horaInicio||"",horaFin:s||i.clases[r].horaFin||""}:i.clases.push({fecha:t,val:o,horas:a||"",horaInicio:n||"",horaFin:s||""}),i.clases.sort((l,d)=>l.fecha.localeCompare(d.fecha)),ve(),Ee()}function yn(e){const t=B.find(a=>a.id===e);if(!t)return;const o=`
    ...
    </div>`;C(`📋 Registrar clase — ${t.nombre}`,"",()=>{const a=document.getElementById("rcFecha").value,n=document.getElementById("rcVal").value,s=document.getElementById("rcHoras").value.trim(),i=document.getElementById("rcHoraInicio").value,r=document.getElementById("rcHoraFin").value;if(!a){p("⚠️ Selecciona una fecha");return}Ft(e,a,n,s,i,r),w(),p("✅ Clase registrada")},o),document.getElementById("mOk").textContent="Guardar clase",setTimeout(()=>Ot("Presente"),60)}function Ot(e){document.getElementById("rcVal").value=e,["rcBtnP","rcBtnF","rcBtnPm"].forEach(t=>{const o=document.getElementById(t);if(!o)return;const a="rcBtn"+e[0]+(e==="Permiso"?"m":"");o.style.opacity=t===a?"1":"0.4",o.style.transform=t===a?"scale(1.04)":"scale(1)"})}function xn(){var r,l;const e=(r=document.getElementById("rcHoraInicio"))==null?void 0:r.value,t=(l=document.getElementById("rcHoraFin"))==null?void 0:l.value;if(!e||!t)return;const[o,a]=e.split(":").map(Number),[n,s]=t.split(":").map(Number),i=n*60+s-(o*60+a);i>0&&(document.getElementById("rcHoras").value=Math.round(i/60*10)/10)}function $n(e,t){const o=B.find(a=>a.id===e);o&&C("Quitar clase","¿Eliminar el registro de esta clase?",()=>{o.clases=o.clases.filter(a=>a.fecha!==t),w(),ve(),Ee()})}function En(e){C("Eliminar alumno","¿Seguro que deseas eliminar este alumno personalizado?",()=>{B=B.filter(t=>t.id!==e),w(),ve(),p("Alumno eliminado"),Ee()})}function ve(){var a;const e=(((a=document.getElementById("persSearch"))==null?void 0:a.value)||"").toLowerCase(),t=B.filter(n=>{var s,i;return n.nombre.toLowerCase().includes(e)||((s=n.dni)==null?void 0:s.includes(e))||((i=n.correo)==null?void 0:i.toLowerCase().includes(e))}),o=document.getElementById("persList");if(t.length===0){o.innerHTML=`<div class="empty"><div class="ei">👤</div>${B.length===0?"Sin alumnos personalizados. Agrégalos con el formulario de arriba.":"Sin resultados."}</div>`;return}o.innerHTML=t.map((n,s)=>{const i=n.clases.length,r=n.clases.filter(u=>u.val==="Presente").length,l=n.clases.reduce((u,m)=>u+(Number.parseFloat(m.horas)||0),0),d=i>0?Math.round(r/i*100):0;let c="var(--red)";return d>=80?c="var(--green)":d>=60&&(c="var(--yellow)"),`
    <div class="pers-card">
    ...
    </div>`}).join("")}function Sn(e){const t=B.find(a=>a.id===e);if(!t)return;const o=`
    ...
    </div>`}).join("")}function wn(e){const t=document.getElementById(`notasBody-${e}`);t&&(t.style.display=t.style.display==="none"?"":"none")}function In(e){C("＋ Nuevo tema de evaluación","",()=>{var i,r;const o=(i=document.getElementById("ntNombre"))==null?void 0:i.value.trim();if(!o){p("⚠️ Escribe el nombre del tema");return}const a=Number.parseFloat((r=document.getElementById("ntMin"))==null?void 0:r.value)||11,n="tema_"+Date.now(),s=Ne(e);s[n]={nombre:o,min:a,fecha:"",notas:{}},g[e].alumnos.forEach(l=>{s[n].notas[l.id]=""}),w(),Pe(e),V(e),p(`✅ Tema "${o}" creado`)},`
    ...
    </div>`),document.getElementById("mOk").textContent="Crear tema"}function _n(e,t,o,a){const n=Ne(e);n[t]&&(n[t].notas[o]=a===""||a===null?"":Number.parseFloat(a),Pe(e),Xt(e))}function Mn(e,t){C("Eliminar tema","¿Eliminar este tema y todas sus notas?",()=>{const o=Ne(e);delete o[t],w(),Pe(e),Kt(e),p("Tema eliminado")})}function st(e){const t=k(e);return t.participacion||(t.participacion={}),t.participacion}function it(e){const t=document.getElementById(`part-section-${e}`);if(!t)return;const o=k(e),a=st(e),n=o.alumnos;if(!n.length){t.innerHTML="";return}t.innerHTML=`
  ...
  </div>`}function Cn(e,t,o){const a=st(e);a[t]=o===""||o===null?"":Number.parseFloat(o),it(e),V(e)}function An(e){const t=Ne(e),o=Object.entries(t);if(!o.length){p("⚠️ Primero crea un tema de evaluación en Notas");return}const a=st(e),s=g[e].alumnos.filter(r=>a[r.id]!==""&&a[r.id]!==null&&a[r.id]!==void 0);if(!s.length){p("⚠️ Primero ingresa puntos de participación");return}const i=`
    ...
    </div>`;C("➕ Sumar participación a nota","",()=>{var d;const r=(d=document.getElementById("sumaTemaId"))==null?void 0:d.value;if(!r||!t[r]){p("⚠️ Selecciona un tema");return}let l=0;s.forEach(c=>{var f;const u=Number.parseFloat(a[c.id])||0,m=Number.parseFloat((f=t[r].notas)==null?void 0:f[c.id])||0,v=Math.min(20,Math.round((m+u)*10)/10);t[r].notas[c.id]=v,l++}),w(),Pe(e),V(e),p(`✅ Participación sumada a ${l} alumno(s) en "${t[r].nombre}"`)},i),document.getElementById("mOk").textContent="Sumar participación"}function zt(e,t,o,a){const{prefix:n,num:s}=Me(o),i=`${n.includes("M")?"Mañana":n.includes("T")?"Tarde":n} Módulo ${s}`,r=a.split("-").reverse().join("/"),l=`Hola ${e.split(" ")[0]}, se le recuerda que el día ${r} registró una falta en ${i}. Por favor comuníquese con su docente.`;rt("whatsapp",e,t,"",l,o,a)}function Tn(e,t,o,a){const{prefix:n,num:s}=Me(o),i=`${n.includes("M")?"Mañana":n.includes("T")?"Tarde":n} Módulo ${s}`,r=a.split("-").reverse().join("/"),l=`Estimado/a ${e},
...
Atentamente,
Instituto Redes & TICs`;rt("correo",e,"",t,l,o,a)}function rt(e,t,o,a,n,s,i){const r=e==="whatsapp";let l="";r||(l=`<div class="fgroup"><div class="flabel">Asunto</div>
    ...
    <div style="display:flex;flex-direction:column;gap:12px;padding-top:4px">
      ...
      `).join("")}function Pn(e,t){const o=g[e];if(!o)return;const a=o.alumnos.find(m=>m.id===t);if(!a)return;const n=_.find(m=>m.id===$),s=((n==null?void 0:n.secciones)||[]).find(m=>m.id===e),i=s?s.label:e;document.getElementById("fichaNombre").textContent=a.nombre,document.getElementById("fichaCarrera").textContent=i;const r=a.cel||"999 999 999 (Simulado)";document.getElementById("fichaTelefono").textContent=r,document.getElementById("btnContactarTwilio").onclick=()=>{zt(a.nombre,r,e,U)};const l=document.getElementById("fichaInasistenciasList"),d=o.asistencias[t]||{},c=Object.keys(d).filter(m=>d[m]==="Falta").sort().reverse();c.length===0?l.innerHTML='<div style="padding:10px; color:var(--muted); font-size:0.8rem; text-align:center;">No registra inasistencias</div>':l.innerHTML=c.slice(0,5).map(m=>`<div style="padding:8px 12px; border-bottom:1px solid var(--border); font-size:0.8rem; display:flex; justify-content:space-between;">
          ...
          </div>`).join("");const u=document.getElementById("overlayFichaAlumno");u&&(u.style.display="flex")}function Ln(){const e=document.getElementById("overlayFichaAlumno");e&&(e.style.display="none")}function Fn(){const e=document.getElementById("dashboardActividadList")||document.querySelector(".dashboard-bottom tbody");if(!e)return;if(!ne||ne.length===0){e.innerHTML='<tr><td colspan="4" style="text-align:center;color:var(--muted);padding:20px;">Sin actividad reciente.</td></tr>';return}const t=ne.slice(0,5);e.innerHTML=t.map(o=>{let n=new Date(o.ts||new Date).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0}),s=o.msg,i="";if(o.msg.includes(" — ")){const l=o.msg.split(" — ");s=l[0],i=l[1]}else i=o.msg,s="Sistema";let r="var(--text)";return i.includes("Presente")?r="var(--green)":i.includes("Falta")?r="var(--red)":i.includes("Permiso")||i.includes("Justificado")?r="var(--blue)":i.includes("retirado")||i.includes("eliminado")?r="var(--red)":i.includes("reactivado")?r="var(--green)":(i.includes("actualizada")||i.includes("hora"))&&(r="var(--amber)"),`
          <tr>
      ...
      <div class="fgroup" style="margin-bottom:16px">
        ...
        <select class="finp" id="expTemplate" onchange="renderExportForm()">
          ...
          ${Object.entries(Le).map(([a,n])=>`<option value="${a}">${n.nombre}</option>`).join("")}
        </select>
      </div>
      <div id="exportFormContainer"></div>
      <div style="display:none" id="exportModOptionsHidden">${t}</div>
      `;C("📥 Exportar Documentos","",()=>{Rt()},o),document.getElementById("mOk").textContent="📥 Generar",document.getElementById("mOk").style.display="none",de={template:"",wordMod:(T&&T.startsWith("redes_")?T:me($)[0])||"",wordMap:{},excelSheets:{}}}window.renderExportForm=function(){const e=document.getElementById("expTemplate").value,t=document.getElementById("exportFormContainer"),o=document.getElementById("mOk");if(!e){t.innerHTML="",o.style.display="none",de.template="";return}de.template=e,o.style.display="block";const a=Le[e],n=document.getElementById("exportModOptionsHidden").innerHTML;let s="";if(a.tipo==="word")s+=`
        ...
        `,t.innerHTML=s,de.wordMod&&(document.getElementById("expWordMod").value=de.wordMod),window.renderWordMapping(e);else if(a.tipo==="excel"&&(s+='<div style="font-size:.8rem;font-weight:600;margin-bottom:8px">Mapeo de Hojas</div>',s+='<div style="display:flex;flex-direction:column;gap:12px;max-height:45vh;overflow-y:auto;padding-right:8px">',a.hojas.forEach((i,r)=>{s+=`
        ...
        `,t.innerHTML=s,de.wordMod)){const i=document.getElementById("expExcMod_0");i&&(i.value=de.wordMod,window.renderExcelMapping(e,0))}};function Dt(e){return!e||!g[e]||!g[e].notas?'<option value="">(Sin asignar)</option>':'<option value="">(Sin asignar)</option>'+Object.entries(g[e].notas).map(([o,a])=>`<option value="${o}">${a.nombre}</option>`).join("")}window.renderWordMapping=function(e){const t=document.getElementById("expWordMod").value;de.wordMod=t;const o=document.getElementById("expWordMappingPanel");if(!t){o.innerHTML='<div style="font-size:.75rem;color:var(--muted)">Selecciona un módulo arriba para mapear sus notas.</div>';return}const a=Le[e],n=Dt(t);let s='<div style="font-size:.75rem;font-weight:600;margin-bottom:8px;color:var(--text)">Mapeo de Notas</div>';a.columnas.forEach(d=>{s+=`
          <div class="fgroup">
            <div class="flabel">Columna: ${d}</div>
            <select class="finp" id="expWordCol_${d.replaceAll(/\s+/g,"")}">${n}</select>
          </div>
        `}),o.innerHTML=s;const i=De[t]||{};document.getElementById("expWordProf").value=i.docente||"";const r=F(t);let l="";r&&r.seccion&&r.seccion.label&&(r.seccion.label.toLowerCase().includes("mañana")?l="Lunes - Miércoles - Viernes 09:00 - 13:00":r.seccion.label.toLowerCase().includes("tarde")&&(l="Lunes - Miércoles - Viernes 14:00 - 16:00")),document.getElementById("expWordTurno").value=l||i.horario||""};window.renderExcelMapping=function(e,t){const o=document.getElementById(`expExcMod_${t}`).value,a=document.getElementById(`expExcMap_${t}`);if(!o){a.innerHTML="";return}const s=Le[e].hojas[t],i=Dt(o);let r="";if(s.columnas.forEach(l=>{r+=`
        ...
        `}),a.innerHTML=r,t===0){const l=De[o]||{};document.getElementById("expExcCurso").value||(document.getElementById("expExcCurso").value=l.curso||""),document.getElementById("expExcProf").value||(document.getElementById("expExcProf").value=l.docente||""),document.getElementById("expExcHorario").value||(document.getElementById("expExcHorario").value=l.horario||""),document.getElementById("expExcFechaI").value||(document.getElementById("expExcFechaI").value=l.fechaI||""),document.getElementById("expExcFechaF").value||(document.getElementById("expExcFechaF").value=l.fechaF||"")}};function Rt(){const e=de.template;if(!e)return;const t=Le[e];t.tipo==="word"?On(e,t):zn(e,t)}function On(e,t){var E,D;const o=document.getElementById("expWordMod").value;if(!o){p("⚠️ Selecciona un módulo origen");return}const a=g[o],n=document.getElementById("expWordProf").value.trim(),s=document.getElementById("expWordLugar").value.trim(),i=document.getElementById("expWordTurno").value.trim(),r={};t.columnas.forEach(M=>{const H=document.getElementById(`expWordCol_${M.replaceAll(/\s+/g,"")}`).value;r[M]=H});const l=[new docx.TableCell({children:[new docx.Paragraph({text:"N°",alignment:docx.AlignmentType.CENTER,style:"boldHeader"})],verticalAlign:docx.VerticalAlign.CENTER}),new docx.TableCell({children:[new docx.Paragraph({text:"Apellidos y Nombres",alignment:docx.AlignmentType.CENTER,style:"boldHeader"})],verticalAlign:docx.VerticalAlign.CENTER}),...t.columnas.map(M=>new docx.TableCell({children:[new docx.Paragraph({text:M,alignment:docx.AlignmentType.CENTER,style:"boldHeader"})],verticalAlign:docx.VerticalAlign.CENTER})),new docx.TableCell({children:[new docx.Paragraph({text:"Código de boleta",alignment:docx.AlignmentType.CENTER,style:"boldHeader"})],verticalAlign:docx.VerticalAlign.CENTER})],d=[new docx.TableRow({children:l,tableHeader:!0})];[...a.alumnos||[]].sort((M,H)=>M.nombre.localeCompare(H.nombre)).forEach((M,H)=>{const q=[new docx.TableCell({children:[new docx.Paragraph({text:String(H+1),alignment:docx.AlignmentType.CENTER})]}),new docx.TableCell({children:[new docx.Paragraph({text:M.nombre})]})];t.columnas.forEach(Y=>{const le=r[Y];let ee="";if(le&&a.notas[le]&&(ee=a.notas[le].notas[M.id],ee==null||ee==="")){const W=Object.entries(a.notas[le].notas).find(([j])=>String(j)===String(M.id));ee=(W==null?void 0:W[1])??""}q.push(new docx.TableCell({children:[new docx.Paragraph({text:ee!==""?String(Number(ee)):"",alignment:docx.AlignmentType.CENTER})]}))});const re=M.dni||`B-${String(Date.now()).slice(-6)}-${H+1}`;q.push(new docx.TableCell({children:[new docx.Paragraph({text:re,alignment:docx.AlignmentType.CENTER})]})),d.push(new docx.TableRow({children:q}))});const m=(De[o]||{}).curso||((D=(E=F(o))==null?void 0:E.seccion)==null?void 0:D.label)||"MÓDULO",v=e==="informe_01"?"INFORME N° 001-2025-CEPTRO-DIMAS":"INFORME N° 001-2025-CEPTRO-DIMAS (Recuperación)",f=e==="informe_01"?`Evaluación modular – ${m.toUpperCase()}`:`Evaluación modular – ${m} (Recuperación)`,b=new Date().toLocaleDateString("es-ES",{year:"numeric",month:"long",day:"numeric"}),h=new Date().toLocaleString("es-ES",{month:"long"}),y=`Tengo el agrado de dirigirme a su digno despacho para saludarle y así mismo para informarle sobre la evaluación modular de ${m.toUpperCase()} de los estudiantes del turno de ${i}; la evaluación se desarrolló en el mes de ${h} obteniendo los resultados que se detallan en la siguiente tabla adjunta:`,x=new docx.Document({styles:{paragraphStyles:[{id:"Normal",name:"Normal",basedOn:"Normal",next:"Normal",run:{font:"Arial",size:22}},{id:"boldHeader",name:"Bold Header",basedOn:"Normal",run:{font:"Arial",size:22,bold:!0}},{id:"underlinedTitle",name:"Underlined Title",basedOn:"Normal",run:{font:"Arial",size:26,bold:!0,underline:{type:docx.UnderlineType.SINGLE}}}]},sections:[{properties:{},children:[new docx.Paragraph({text:v,alignment:docx.AlignmentType.CENTER,style:"underlinedTitle",spacing:{after:300}}),new docx.Paragraph({children:[new docx.TextRun({text:"AL :  ",bold:!0}),new docx.TextRun({text:"CEPTRO DIMAS"})],spacing:{after:100}}),new docx.Paragraph({children:[new docx.TextRun({text:"DEL : ",bold:!0}),new docx.TextRun({text:`Prof.: ${n}`})],spacing:{after:100}}),new docx.Paragraph({children:[new docx.TextRun({text:"ASUNTO : ",bold:!0}),new docx.TextRun({text:f})],spacing:{after:100}}),new docx.Paragraph({children:[new docx.TextRun({text:"FECHA: ",bold:!0}),new docx.TextRun({text:`${s}, ${b}`})],spacing:{after:300}}),new docx.Paragraph({text:y,spacing:{after:300},alignment:docx.AlignmentType.JUSTIFIED}),new docx.Table({rows:d,width:{size:100,type:docx.WidthType.PERCENTAGE}}),new docx.Paragraph({text:"",spacing:{after:800}}),new docx.Paragraph({text:"___________________________________",alignment:docx.AlignmentType.CENTER}),new docx.Paragraph({text:n,alignment:docx.AlignmentType.CENTER}),new docx.Paragraph({text:"Profesor",alignment:docx.AlignmentType.CENTER})]}]});docx.Packer.toBlob(x).then(M=>{var Y,le;const H=window.URL.createObjectURL(M),q=document.createElement("a");q.href=H;const re=e==="informe_01"?"Informe_Modular":"Informe_Recuperacion";q.download=`${re}_${((le=(Y=F(o))==null?void 0:Y.seccion)==null?void 0:le.badge)||"Modulo"}_${U}.docx`,q.click(),p("📥 Documento Word generado exitosamente"),w()}).catch(M=>{console.error(M),p("⚠️ Error generando Word")})}function zn(e,t){var d,c;const o=XLSX.utils.book_new(),a=document.getElementById("expExcCurso").value.trim(),n=document.getElementById("expExcProf").value.trim(),s=document.getElementById("expExcHorario").value.trim(),i=document.getElementById("expExcFechaI").value,r=document.getElementById("expExcFechaF").value;let l=new Set;if(t.hojas.forEach((u,m)=>{const v=document.getElementById(`expExcMod_${m}`).value;if(!v)return;l.add(v);const f=g[v];if(!f||!f.alumnos.length)return;const b={};u.columnas.forEach(j=>{b[j]=document.getElementById(`expExcCol_${m}_${j.replaceAll(/\s+/g,"")}`).value});const h=De[v]||{},y=[...f.fechas||[]].sort(),x=Array.from({length:6},(j,N)=>{const G=Math.floor(N*y.length/6),J=Math.floor((N+1)*y.length/6);return y.slice(G,J)}),E=[...f.alumnos].sort((j,N)=>j.nombre.localeCompare(N.nombre)),D=a||h.curso||u.nombre,M=n||h.docente||"",H=s||h.horario||"",q=i?Ae(i):h.fechaI?Ae(h.fechaI):"",re=r?Ae(r):h.fechaF?Ae(h.fechaF):"",Y=(j,N)=>{const G=b[N];if(!G||!f.notas[G])return"";let J=f.notas[G].notas[j.id];if(J==null||J===""){const S=Object.entries(f.notas[G].notas).find(([I])=>String(I)===String(j.id));J=(S==null?void 0:S[1])??""}return J===""?"":Number(J)},le=(j,N)=>{if(!x[N]||!x[N].length)return"";const G=f.asistencias[j.id]||{};return x[N].filter(S=>(G[S]||"")==="Presente").length/x[N].length>.5?"P":"F"},ee=j=>String.fromCharCode(65+j);let W;if(e==="registro_ofimatica"){const j=u.columnas.length,N=9,G=N+j,J=G+1,S=[],I=L=>{const X=Array(J).fill("");return X[2]=L,X};S.push(I(D)),S.push(I(M)),S.push(I(H)),S.push(I(q)),S.push(I(re)),S.push(Array(J).fill(""));const A=Array(J).fill("");A[0]="N° ORDEN",A[1]="APELLIDOS y NOMBRES",A[2]="ASISTENCIA",u.columnas.forEach((L,X)=>{A[N+X]=L}),A[G]="PROM",S.push(A);const he=Array(J).fill("");for(let L=0;L<6;L++)he[2+L]=L+1;S.push(he),E.forEach((L,X)=>{const be=9+X,ce=Array(J).fill("");ce[0]=X+1,ce[1]=L.nombre;for(let te=0;te<6;te++)ce[2+te]=le(L,te);u.columnas.forEach((te,Ce)=>{ce[N+Ce]=Y(L,te)}),ce[G]={t:"n",f:`AVERAGE(${ee(N)}${be}:${ee(N+j-1)}${be})`},S.push(ce)}),W=XLSX.utils.aoa_to_sheet(S),W["!cols"]=[{wch:5},{wch:33},{wch:4.5},{wch:4.5},{wch:4.5},{wch:4.5},{wch:4.5},{wch:4.5},{wch:2.5},...u.columnas.map(()=>({wch:5.5})),{wch:6}],W["!rows"]=[],W["!rows"][5]={hpt:11},W["!rows"][6]={hpt:30},W["!rows"][7]={hpt:22};const Z=[];for(let L=0;L<5;L++)Z.push({s:{r:L,c:2},e:{r:L,c:J-1}});Z.push({s:{r:6,c:0},e:{r:7,c:0}}),Z.push({s:{r:6,c:1},e:{r:7,c:1}}),Z.push({s:{r:6,c:2},e:{r:6,c:7}}),u.columnas.forEach((L,X)=>Z.push({s:{r:6,c:N+X},e:{r:7,c:N+X}})),Z.push({s:{r:6,c:G},e:{r:7,c:G}}),W["!merges"]=Z}else{const j=u.columnas.length,N=21,G=25,J=26,S=17,I=[],A=()=>Array(J).fill("");I.push(A());const he=A();he[1]="REGISTRO DE EVALUACIÓN",he[17]="ESPECIALIDAD",he[22]="Computación e Informática",I.push(he),I.push(A());const Z=A();Z[0]="TOTAL MATRICULADOS",Z[2]=E.length,Z[17]="MÓDULO",Z[22]="Diseño Gráfico",I.push(Z),I.push(A());const L=A();L[0]="ALUMNOS APROBADOS",L[17]="PROGRAMA",L[22]=u.nombre,I.push(L),I.push(A());const X=A();X[0]="ALUMNOS DESAPROBADOS",X[17]="DÍAS DE CLASE",X[22]=H||"Sábado",I.push(X),I.push(A());const be=A();be[0]="ALUMNOS INHABILITADOS",be[17]="HORAS",be[22]=h.horario||"",I.push(be),I.push(A());const ce=A();ce[17]="FECHA DE INICIO",ce[22]=q,I.push(ce),I.push(A());const te=A();te[0]="CLASES DICTADAS",te[2]=y.length,te[17]="FECHA DE TÉRMINO",te[22]=re,I.push(te),I.push(A());const Ce=A();Ce[17]="PROFESORA",Ce[22]=M,I.push(Ce),I.push(A());const ye=A();ye[0]="N°",ye[1]="APELLIDOS Y NOMBRES",ye[2]="ASISTENCIA",ye[20]="N°",u.columnas.forEach((O,fe)=>{ye[N+fe]=O}),ye[G]="NOTA FINAL",I.push(ye);const dt=A();for(let O=0;O<6;O++)dt[2+O]=O+1;I.push(dt),E.forEach((O,fe)=>{const ut=20+fe,xe=A();xe[0]=fe+1,xe[1]=O.nombre,xe[20]=fe+1;for(let Se=0;Se<6;Se++)xe[2+Se]=le(O,Se);u.columnas.forEach((Se,jt)=>{xe[N+jt]=Y(O,Se)}),xe[G]={t:"n",f:`AVERAGE(${ee(N)}${ut}:${ee(N+j-1)}${ut})`},I.push(xe)}),W=XLSX.utils.aoa_to_sheet(I),W["!cols"]=[{wch:5},{wch:30},{wch:4},{wch:4},{wch:4},{wch:4},{wch:4},{wch:4},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:5},...u.columnas.map(()=>({wch:7})),{wch:4},{wch:8}].slice(0,J),W["!rows"]=[],W["!rows"][S]={hpt:30},W["!rows"][S+1]={hpt:22};const oe=[];[1,3,5,7,9,11,13,15].forEach(O=>{oe.push({s:{r:O,c:17},e:{r:O,c:20}}),oe.push({s:{r:O,c:22},e:{r:O,c:25}})}),[3,5,7,9,13].forEach(O=>oe.push({s:{r:O,c:0},e:{r:O,c:1}})),[3,13].forEach(O=>oe.push({s:{r:O,c:2},e:{r:O,c:5}})),oe.push({s:{r:1,c:1},e:{r:1,c:4}}),oe.push({s:{r:S,c:0},e:{r:S+1,c:0}}),oe.push({s:{r:S,c:1},e:{r:S+1,c:1}}),oe.push({s:{r:S,c:2},e:{r:S,c:7}}),oe.push({s:{r:S,c:20},e:{r:S+1,c:20}}),u.columnas.forEach((O,fe)=>oe.push({s:{r:S,c:N+fe},e:{r:S+1,c:N+fe}})),oe.push({s:{r:S,c:G},e:{r:S+1,c:G}}),W["!merges"]=oe}XLSX.utils.book_append_sheet(o,W,u.nombre.slice(0,31))}),o.SheetNames.length>0){let u="";if(l.size===1){const v=[...l][0];u="_"+(((c=(d=F(v))==null?void 0:d.seccion)==null?void 0:c.badge)||v)}const m=e==="registro_ofimatica"?"Registro_Curso":"Registro_Taller";XLSX.writeFile(o,`${m}${u}_${U}.xlsx`),p(`📥 Excel generado con ${o.SheetNames.length} hoja(s)`),w()}else p("⚠️ No se seleccionaron módulos con alumnos para ninguna hoja.")}function Ae(e){if(!e)return"";const[t,o,a]=e.split("-");return`${a}/${o}/${t}`}function Hn(){Ht()}function Fe(){return!!K}const Dn=["fer250423@gmail.com"];function lt(e){if(!ue)try{ue=firebase.initializeApp(e),K=firebase.firestore(ue),localStorage.setItem("fb_config",JSON.stringify(e)),Rn()}catch(t){console.error("Firebase init error:",t)}}function ct(e){try{return JSON.parse(e)}catch{}try{const t=e.replace(/\/\/.*$/gm,"").replace(/(\w+)(\s*):/g,'"$1":').replaceAll("'",'"');return JSON.parse(t)}catch{}try{const t=e.match(/\{[\s\S]+\}/);if(t)return JSON.parse(t[0])}catch{}throw new Error("No se pudo parsear la configuración")}function Ue(){const e=localStorage.getItem("fb_config");let t=e||"";try{t=JSON.stringify(JSON.parse(t),null,2)}catch{}const o=`
  ...
  "appId": "..."
    ...
    </div>`;C("🔥 Configurar Firebase","",()=>{const a=document.getElementById("fbConfigInput").value.trim();if(!a){p("⚠️ Pega la configuración");return}try{const n=ct(a);lt(n),w(),p("✅ Firebase configurado")}catch(n){p("⚠️ Config inválida: "+n.message)}},o),document.getElementById("mOk").textContent="Guardar y conectar"}function Rn(){ue&&firebase.auth(ue).onAuthStateChanged(e=>{const t=document.getElementById("loginScreen"),o=document.getElementById("mainLayout");e?Dn.includes(e.email)?(t.style.display="none",o.style.display="flex"):(document.getElementById("loginError").style.display="block",firebase.auth(ue).signOut()):(t.style.display="flex",o.style.display="none")})}function jn(){if(!ue){const t=localStorage.getItem("fb_config");if(t)try{lt(ct(t))}catch(o){console.error("Config inválida guardada:",o),Ue();return}else{Ue();return}}const e=new firebase.auth.GoogleAuthProvider;firebase.auth(ue).signInWithPopup(e).then(t=>{const o=t.user;document.getElementById("loginScreen").style.display="none",document.getElementById("mainLayout").style.display="flex",console.log("Login exitoso:",o.email)}).catch(t=>{console.error("Error en login:",t),t.code==="auth/popup-blocked"?alert("El navegador bloqueó la ventana emergente. Permite popups para este sitio."):alert("Error al iniciar sesión: "+t.message)})}function Gn(){firebase.auth(ue).signOut().then(()=>{document.getElementById("loginScreen").style.display="flex",document.getElementById("mainLayout").style.display="none"})}const Jn={loginWithGoogle:jn,logoutGoogle:Gn,applyTheme:qe,toggleTheme:Gt,showToast:p,showModal:C,closeModal:w,goPage:ze,switchGrupoAndPage:wo,switchGrupo:_t,toggleSidebar:Jt,toggleCarreraBlock:So,globalSearch:Wt,closeGlobalSearch:Ut,showFirebaseConfig:Ue,showExportModal:Ht,exportarBackupJSON:po,importarBackupJSON:fo,showAddCarreraModal:oo,cargarAsistencia:Co,importExcel:Bo,showGoogleSheetsSyncModal:Ct,showAddAlumnoModal:vn,propagarAlumnos:gn,showMoverModuloCompleto:dn,setDateQuick:Ro,onDateChange:Nt,setAsist:Go,setAsistConMotivo:Uo,marcarTodos:pn,showPerfil:Vo,enviarWhatsApp:zt,enviarCorreo:Tn,showMensajeModal:rt,showEditarAlumno:hn,showMoverAlumno:Yo,eliminarAlumno:fn,retirarAlumno:Ko,reactivarAlumno:Qo,quitarFechaModulo:mn,renderPersonalizados:ve,agregarPersonalizado:bn,editarPersonalizado:Sn,eliminarPersonalizado:En,showRegistrarClaseModal:yn,registrarClasePersonalizada:Ft,quitarClasePersonalizada:$n,selectRcVal:Ot,rcAutoHoras:xn,showAddNotaModal:In,toggleNotasTema:wn,setNota:_n,eliminarTema:Mn,renderParticipacion:it,setParticipacion:Cn,showSumarParticipacionModal:An,renderMensual:kt,renderHistorialMini:eo,renderAdminCarreras:xt,clearHistorial:mo,renderHoras:ge,initHorasForm:wt,sincronizarHorasLog:et,showAgregarHoraManual:Wo,setClaseBase:lo,actualizarHora:co,eliminarHora:uo,showPromptClaseInfo:Je,abrirFichaAlumno:Pn,cerrarFichaAlumno:Ln,renderExportForm,renderWordMapping,renderExcelMapping,generarExportacion:Rt,exportarTodo:Hn,fmtFechaMeta:Ae,syncSheetTicsSabados:Qe,eliminarCarrera:to};Object.entries(Jn).forEach(([e,t])=>{window[e]=t});
