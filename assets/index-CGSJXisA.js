(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();let g={},B=[];try{B=JSON.parse(localStorage.getItem("asist_personalizados")||"[]")}catch{B=[]}let oe=JSON.parse(localStorage.getItem("asist_historial")||"[]"),de=null,Ie=JSON.parse(localStorage.getItem("clase_base_config")||"{}"),Fe=null,P=JSON.parse(localStorage.getItem("horas_log")||"[]"),se={};try{se=JSON.parse(localStorage.getItem("asist_empty_modules")||"{}")}catch{se={}}let T="dashboard";const U=new Date().toISOString().split("T")[0];if(B.length===0&&P.some(e=>(e==null?void 0:e._tipo)==="personalizado")){const e=new Map;P.filter(t=>(t==null?void 0:t._tipo)==="personalizado").forEach((t,o)=>{const a=Number(t._pid),n=Number.isFinite(a)&&a>0?a:Date.now()+o;e.has(n)||e.set(n,{id:n,nombre:t.curso||"Clase personalizada",tel:"",clases:[]});const s=e.get(n);t.fecha&&!s.clases.some(i=>i.fecha===t.fecha)&&s.clases.push({fecha:t.fecha,val:["Presente","Falta","Permiso"].includes(t.obsv)?t.obsv:"Presente",horas:t.horas||"",horaInicio:t.entrada||"",horaFin:t.salida||""})}),B=[...e.values()].sort((t,o)=>t.nombre.localeCompare(o.nombre,"es",{sensitivity:"base"})),localStorage.setItem("asist_personalizados",JSON.stringify(B))}function Ue(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("asist_theme",e);const t=document.getElementById("themeLabel");t&&(t.textContent=e==="dark"?"🌙 Modo oscuro":"☀️ Modo claro")}function jt(){const e=document.documentElement.getAttribute("data-theme")||"dark";Ue(e==="dark"?"light":"dark")}function p(e){const t=document.getElementById("toast");t&&(t.textContent=e,t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),3e3))}function C(e,t,o,a){const n=document.getElementById("overlay"),s=document.getElementById("mTitle"),i=document.getElementById("mBody"),r=document.getElementById("mExtra"),l=document.getElementById("mOk");n&&(s.textContent=e||"",i.textContent=t||"",r.innerHTML=a||"",l.style.display=o?"inline-block":"none",l.onclick=()=>{typeof o=="function"&&o()},n.classList.add("show"))}function E(){const e=document.getElementById("overlay");e&&e.classList.remove("show")}function z(){localStorage.setItem("asist_state",JSON.stringify(g))}function K(e,t,o){oe.unshift({icon:e,msg:t,ctx:o,ts:Date.now()}),oe.length>200&&oe.pop(),localStorage.setItem("asist_historial",JSON.stringify(oe))}function Gt(){const e=document.getElementById("sidebar"),t=document.getElementById("sidebarOverlay");e&&e.classList.toggle("hidden"),t&&t.classList.toggle("show")}function Jt(e){const t=document.getElementById("globalResults");if(!t)return;if(!e.trim()){t.classList.remove("show");return}const o=[];me().forEach(a=>{const n=g[a];n&&n.alumnos.forEach(s=>{s.nombre.toLowerCase().includes(e.toLowerCase())&&o.push({nombre:s.nombre,curso:a})})}),B.forEach(a=>{a.nombre.toLowerCase().includes(e.toLowerCase())&&o.push({nombre:a.nombre,curso:"Personalizado"})}),o.length===0?t.innerHTML='<div class="gr-empty">Sin resultados</div>':t.innerHTML=o.slice(0,8).map(a=>`<div class="gr-item"><div class="gr-name">${a.nombre}</div><div class="gr-sub">${a.curso}</div></div>`).join(""),t.classList.add("show")}function Wt(){const e=document.getElementById("globalResults");e&&e.classList.remove("show")}function je(e,t){if(!e||!t)return 0;const[o,a]=e.split(":").map(Number),[n,s]=t.split(":").map(Number),i=n*60+s-(o*60+a);return i>0?Math.round(i/60*10)/10:0}function we(){localStorage.setItem("horas_log",JSON.stringify(P))}const De={};function Ut(e){return JSON.parse(JSON.stringify(e??null))}function qt(e){const t=Z(e);return Ut({alumnos:t.alumnos||[],retirados:t.retirados||[],asistencias:t.asistencias||{},fechas:t.fechas||[],motivos:t.motivos||{},notas:t.notas||{},participacion:t.participacion||{},emptiedAt:se[e]&&(t.alumnos||[]).length===0?new Date(se[e]).toISOString():null})}function Vt(e){return e&&g[e]?[e]:!e&&T&&g[T]?[T]:[]}async function qe(e){if(!Le()||!e||!g[e])return!1;const t=qt(e);return t.updatedAt=firebase.firestore.FieldValue.serverTimestamp(),await Fe.collection("modulos").doc(e).set(t),!0}function V(e){z();const t=Vt(e);return!Le()||t.length===0?Promise.resolve(!1):(t.forEach(o=>{clearTimeout(De[o]),De[o]=setTimeout(()=>{delete De[o],qe(o).catch(a=>{console.error("Error sincronizando modulo:",o,a),p("No se pudo sincronizar con Firebase: "+a.message)})},350)}),Promise.resolve(!0))}function Ae(e,t,o,a,n){return V(e)}function Ve(e,t,o){return z(),Le()?qe(e):Promise.resolve(!1)}function bt(e,t){return z(),Le()?qe(e):Promise.resolve(!1)}function $e(){localStorage.setItem("asist_personalizados",JSON.stringify(B))}function Xt(e){return V(e)}function Kt(e){return V(e)}function ut(e){return String(e||"").trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function Qt(e){return["Presente","Falta","Permiso"].includes(e==null?void 0:e.obsv)?e.obsv:"Presente"}function Yt(e){const t=new Map;return(e||[]).filter(o=>o&&(o._tipo==="personalizado"||String(o._uid||"").startsWith("pers_"))).forEach((o,a)=>{const n=Number(o._pid),s=Number.isFinite(n)&&n>0?n:Date.now()+a;t.has(s)||t.set(s,{id:s,nombre:o.curso||"Clase personalizada",tel:"",clases:[],_lastFecha:""});const i=t.get(s);o.fecha&&String(o.fecha).localeCompare(i._lastFecha||"")>=0&&o.curso&&(i.nombre=o.curso,i._lastFecha=o.fecha),o.fecha&&!i.clases.some(r=>r.fecha===o.fecha)&&i.clases.push({fecha:o.fecha,val:Qt(o),horas:o.horas||"",horaInicio:o.entrada||"",horaFin:o.salida||""})}),[...t.values()].map(({_lastFecha:o,...a})=>a)}function Zt(e){const t=Array.isArray(e==null?void 0:e.personalizados)?e.personalizados:[],o=Yt(Array.isArray(e==null?void 0:e.horasLog)?e.horasLog:[]),a=t.length>0?t:o;if(a.length===0)return{alumnos:0,clases:0,horas:0};let n=0,s=0;a.forEach(r=>{const l=String(r.id||"");let d=B.find(c=>String(c.id)===l);d||(d=B.find(c=>ut(c.nombre)===ut(r.nombre))),d||(d={...r,id:r.id||Date.now()+Math.random(),clases:[]},B.push(d),n++),Array.isArray(d.clases)||(d.clases=[]),(r.clases||[]).forEach(c=>{if(!(c!=null&&c.fecha))return;const u=d.clases.find(m=>m.fecha===c.fecha);u?(!u.val&&c.val&&(u.val=c.val),!u.horas&&c.horas&&(u.horas=c.horas),!u.horaInicio&&c.horaInicio&&(u.horaInicio=c.horaInicio),!u.horaFin&&c.horaFin&&(u.horaFin=c.horaFin)):(d.clases.push({...c}),s++)}),d.clases.sort((c,u)=>String(c.fecha).localeCompare(String(u.fecha)))});let i=0;return((e==null?void 0:e.horasLog)||[]).filter(r=>r&&(r._tipo==="personalizado"||String(r._uid||"").startsWith("pers_"))).forEach(r=>{const l=r._uid||`pers_${r._pid||r.curso}_${r.fecha}`;P.some(c=>String(c._uid||"")===String(l))||P.some(c=>c._tipo==="personalizado"&&String(c._pid||"")===String(r._pid||"")&&c.fecha===r.fecha)||(P.push({...r,_uid:l,_tipo:"personalizado"}),i++)}),B.sort((r,l)=>r.nombre.localeCompare(l.nombre,"es",{sensitivity:"base"})),$e(),we(),{alumnos:n,clases:s,horas:i}}function kt(){}function eo(){}function yt(){const e=document.getElementById("adminCarrerasList");e&&(e.innerHTML=_.map(t=>`
  ...
  `,()=>{const t=document.getElementById("newCarreraNombre").value.trim(),o=document.getElementById("newCarreraIcono").value.trim()||"📚";if(!t){p("⚠️ Escribe un nombre");return}const a="carrera_"+Date.now().toString(36),n={id:a,nombre:t,icono:o,color:"var(--violet)",secciones:[{id:a+"_M1",label:"Turno Mañana - Módulo 1",badge:"M1"}]};_.push(n),localStorage.setItem("asist_carreras",JSON.stringify(_)),E(),p("✅ Carrera creada"),setTimeout(()=>location.reload(),1e3)})}function xt(e){const t=String(e||"");if(/^\d{4}-\d{2}-\d{2}$/.test(t))return t.slice(0,7);const o=t.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/);return o?`${o[3]}-${String(o[2]).padStart(2,"0")}`:""}function Xe(e){const t=String(e||"");if(/^\d{4}-\d{2}-\d{2}$/.test(t)){const[o,a,n]=t.split("-");return`${n}/${a}/${o}`}return t||"—"}function no(e){if(!e)return"";const[t,o]=e.split("-").map(Number);return new Date(t,o-1,1).toLocaleDateString("es-ES",{month:"long",year:"numeric"})}function $t(e){var t;return e._tipo==="modulo"?e._grupo||((t=F(e._key))==null?void 0:t.carrera.id)||$:e._grupo||$}function ao(){var t;const e=((t=document.getElementById("horasFiltroMes"))==null?void 0:t.value)||"";return P.filter(o=>o&&o.fecha).filter(o=>$t(o)===$||!$).filter(o=>!e||xt(o.fecha)===e).sort((o,a)=>String(o.fecha).localeCompare(String(a.fecha))||String(o.curso||"").localeCompare(String(a.curso||"")))}function Et(){const e=document.getElementById("horasFiltroMes");if(!e)return;const t=e.value,o=[...new Set(P.filter(a=>$t(a)===$||!$).map(a=>xt(a.fecha)).filter(Boolean))].sort().reverse();e.innerHTML='<option value="">Todos los meses</option>'+o.map(a=>`<option value="${a}">${no(a)}</option>`).join(""),t&&o.includes(t)&&(e.value=t)}function mt(e){return e._key||(e._tipo==="personalizado"?`pers_${e._pid||e.curso}`:e.curso||"manual")}function so(e,t){const o=mt(e),a=[...new Set(t.filter(r=>mt(r)===o).map(r=>r.fecha))].sort(),n=a.indexOf(e.fecha),s=Ie[o];if(!s||!s.fecha||!s.numero)return n>=0?n+1:"";const i=a.indexOf(s.fecha);return i===-1||n===-1?n+1:Math.max(1,Number(s.numero)+n-i)}function Re(e,t,o,a){const n=document.getElementById(e);if(n){if(t.length===0){n.innerHTML=`<tr><td colspan="12"><div class="empty"><div class="ei">📋</div>${a}</div></td></tr>`;return}n.innerHTML=t.map(s=>{const i=String(s._uid||s.id),r=so(s,o),l=s._tipo==="manual";return`
      <tr>
    ...
    <div class="stats-grid" style="grid-template-columns:repeat(5,1fr);margin-bottom:16px">
    ...
    </div>`}function ro(e){const t=document.getElementById("horasFuentesGrid");if(!t)return;const a=ue($).map(n=>{const s=F(n),i=e.filter(l=>l._tipo==="modulo"&&l._key===n).length,r=e.filter(l=>l._tipo==="modulo"&&l._key===n).reduce((l,d)=>l+(Number.parseFloat(d.horas)||0),0);return`<div class="stat" style="padding:12px 14px">
      ...
      <div style="font-family:'JetBrains Mono',monospace;color:var(--green-l);font-size:.78rem;margin-top:3px">${r.toFixed(1)} h</div>
        ...
        `),document.getElementById("btnRestaurarTodo").onclick=()=>{s.state&&(g=s.state),s.personalizados&&(B=s.personalizados,$e()),s.historial&&(oe=s.historial,localStorage.setItem("asist_historial",JSON.stringify(oe))),s.carreras&&(_=s.carreras,localStorage.setItem("asist_carreras",JSON.stringify(_))),s.horasLog&&(P=s.horasLog),s.claseBaseConfig&&(Ie=s.claseBaseConfig),(s.googleSheetsSync||s.googleSheetsSyncConfig||s.google_sheets_sync)&&(ae=s.googleSheetsSync||s.googleSheetsSyncConfig||s.google_sheets_sync,Ye()),z(),we(),E(),p("📂 Backup completo restaurado"),setTimeout(()=>location.reload(),1e3)},document.getElementById("btnRestaurarPersonalizados").onclick=()=>{const r=Zt(s);if(E(),ge(),T==="horas"&&fe(),r.alumnos===0&&r.clases===0&&r.horas===0){p("⚠️ El backup no contiene clases personalizadas para fusionar");return}p(`✅ Personalizados fusionados: ${r.alumnos} alumno(s), ${r.clases} clase(s), ${r.horas} hora(s)`)},document.getElementById("btnRestaurarSheets").onclick=()=>{const r=Fo(s);if(E(),r===0){p("⚠️ El backup no contiene configuración de Google Sheets");return}p(`✅ Configuración Google Sheets fusionada: ${r} módulo(s)`)},document.getElementById("btnRestaurarRedes").onclick=()=>{s.state?(Object.keys(s.state).forEach(r=>{r.startsWith("redes_")&&(g[r]=s.state[r])}),z(),E(),p("✅ Asistencias de Redes & TICs recuperadas"),setTimeout(()=>location.reload(),1e3)):p("⚠️ El archivo no contiene datos de estado válidos")}}catch{p("❌ Backup inválido")}},a.readAsText(o)},e.click()}Ue(localStorage.getItem("asist_theme")||document.documentElement.getAttribute("data-theme")||"dark");const It=[{id:"redes",nombre:"Redes & TICs",icono:"🖥️",color:"var(--amber)",secciones:[{id:"redes_M_1",label:"Turno Mañana - Módulo 1",badge:"Mañana M1"},{id:"redes_M_2",label:"Turno Mañana - Módulo 2",badge:"Mañana M2"},{id:"redes_M_3",label:"Turno Mañana - Módulo 3",badge:"Mañana M3"},{id:"redes_M_4",label:"Turno Mañana - Módulo 4",badge:"Mañana M4"},{id:"redes_T_1",label:"Turno Tarde - Módulo 1",badge:"Tarde M1"},{id:"redes_T_2",label:"Turno Tarde - Módulo 2",badge:"Tarde M2"},{id:"redes_T_3",label:"Turno Tarde - Módulo 3",badge:"Tarde M3"},{id:"redes_T_4",label:"Turno Tarde - Módulo 4",badge:"Tarde M4"}]},{id:"info_gastro",nombre:"Tecnologías de la Información",icono:"👨‍🍳",color:"var(--teal)",secciones:[{id:"info_gastro_L_1",label:"Clase Lunes",badge:"Lunes"}]},{id:"tics_sabados",nombre:"Tecnologías Turno mañana sábados",icono:"📅",color:"var(--violet)",googleSheetCsvUrl:"",secciones:[{id:"tics_S_1",label:"Turno Sábado - Módulo 1",badge:"Sáb M1"},{id:"tics_S_2",label:"Turno Sábado - Módulo 2",badge:"Sáb M2"},{id:"tics_S_3",label:"Turno Sábado - Módulo 3",badge:"Sáb M3"},{id:"tics_S_4",label:"Turno Sábado - Módulo 4",badge:"Sáb M4"}]}];let _=null;var vt;try{let e=JSON.parse(localStorage.getItem("asist_carreras"));if(e&&e.length){const t=new Set;e=e.filter(s=>t.has(s.id)?!1:(t.add(s.id),!0));const o=s=>(s||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]/g," ").replace(/\s+/g," ").trim();e=e.filter(s=>s.id==="tics_sabados"?!0:!o(s.nombre).includes("sabado"));const a=It.find(s=>s.id==="tics_sabados"),n=e.find(s=>s.id==="tics_sabados");!n&&a?e.push(a):n&&a&&!n.googleSheetCsvUrl&&(n.googleSheetCsvUrl=a.googleSheetCsvUrl),(vt=n==null?void 0:n.googleSheetCsvUrl)!=null&&vt.includes("docs.google.com/spreadsheets/d/")&&(n.googleSheetCsvUrl=""),localStorage.setItem("asist_carreras",JSON.stringify(e)),_=e}}catch{}_||(_=It);var _dr=It.find(c=>c.id==="redes"),_cr=_.find(c=>c.id==="redes");if(_dr&&_cr){var _es=new Set(_cr.secciones.map(s=>s.id));_dr.secciones.forEach(s=>{if(!_es.has(s.id))_cr.secciones.push(s)});localStorage.setItem("asist_carreras",JSON.stringify(_))}let $=localStorage.getItem("currentGrupo");var ht;(!$||!_.find(e=>e.id===$))&&($=((ht=_[0])==null?void 0:ht.id)||"redes");function me(){return _.flatMap(e=>e.secciones.map(t=>t.id))}function ue(e){const t=_.find(o=>o.id===e);return t?t.secciones.map(o=>o.id):[]}function F(e){for(const t of _){const o=t.secciones.find(a=>a.id===e);if(o)return{carrera:t,seccion:o}}return null}function _e(e){if(e.includes("-")){const n=e.split("-");return{prefix:n[0],num:Number.parseInt(n[1])||1,isLegacy:!0}}const t=e.split("_"),o=Number.parseInt(t.pop())||1;return{prefix:t.join("_"),num:o,isLegacy:!1}}function go(e){const t=localStorage.getItem("asist_state");if(t)try{const o=JSON.parse(t),a={...o};let n=!1;for(const[s,i]of Object.entries(e))o[s]&&(o[s].alumnos||[]).length>0&&(a[i]=a[i]?{...a[i],...o[s]}:o[s],delete a[s],n=!0);n&&localStorage.setItem("asist_state",JSON.stringify(a))}catch(o){console.warn("Error en migración de asist_state",o)}}function vo(e){const t=localStorage.getItem("horas_log");if(t)try{const o=JSON.parse(t);let a=!1;o.forEach(n=>{var s;if(e[n._key]&&(n._key=e[n._key],a=!0),(s=n._uid)!=null&&s.startsWith("mod_"))for(const[i,r]of Object.entries(e))n._uid.includes(`_${i}_`)&&(n._uid=n._uid.replaceAll(`_${i}_`,`_${r}_`),a=!0)}),a&&localStorage.setItem("horas_log",JSON.stringify(o))}catch(o){console.warn("Error en migración de horas_log",o)}}(function(){const t={"M-1":"redes_M_1","M-2":"redes_M_2","M-3":"redes_M_3","M-4":"redes_M_4","T-1":"redes_T_1","T-2":"redes_T_2","T-3":"redes_T_3","T-4":"redes_T_4","G-1":"info_gastro_L_1","G-2":"info_gastro_L_2","G-3":"info_gastro_L_3","G-4":"info_gastro_L_4"};go(t),vo(t)})();try{const e=JSON.parse(localStorage.getItem("asist_state")||"{}");e&&typeof e=="object"&&Object.assign(g,e)}catch{}me().forEach(e=>{g[e]?(g[e].alumnos||(g[e].alumnos=[]),g[e].retirados||(g[e].retirados=[]),g[e].asistencias||(g[e].asistencias={}),g[e].fechas||(g[e].fechas=[]),g[e].motivos||(g[e].motivos={}),g[e].notas||(g[e].notas={}),g[e].participacion||(g[e].participacion={})):g[e]={alumnos:[],retirados:[],asistencias:{},fechas:[],motivos:{},notas:{},participacion:{}}});document.getElementById("topbarDate").textContent=new Date().toLocaleDateString("es",{weekday:"long",year:"numeric",month:"long",day:"numeric"});const pt=localStorage.getItem("fb_config");if(pt)try{rt(lt(pt))}catch{}me().forEach(e=>{const t=document.createElement("div");t.className="page",t.id=`page-${e}`,t.innerHTML=To(e),document.querySelector(".content").appendChild(t)});_.forEach(e=>{const t=document.createElement("div");t.className="page",t.id=`page-carrera_${e.id}`,t.innerHTML=Ao(e),document.querySelector(".content").appendChild(t)});Qe();ze();function ho(e){let t=0;for(let a=0;a<Math.min(e.length,5);a++){const n=e[a].join(" ").toLowerCase();if(n.includes("apellido")||n.includes("nombre")||n.includes("dni")){t=a;break}}const o=e[t].map(a=>String(a||"").trim().toLowerCase());return{headerIdx:t,idxNombre:o.findIndex(a=>a.includes("apellido")||a.includes("nombre")),idxDni:o.indexOf("dni"),idxCorreo:o.findIndex(a=>a.includes("correo")||a.includes("email")),idxNac:o.findIndex(a=>a.includes("nac")||a.includes("nacimiento")),idxCel:o.findIndex(a=>a.includes("celular")||a.includes("tel")||a.includes("cel")),idxEdad:o.indexOf("edad")}}function bo(e){if(!e||e.length<2)return[];const t=ho(e),o=[];for(let a=t.headerIdx+1;a<e.length;a++){const n=e[a],s=String(n[Math.max(0,t.idxNombre)]||"").trim();if(!s||s.length<3)continue;const i=s.toLowerCase();i.includes("total")||i.includes("nombre")||/^[=]/.test(s)||o.push({id:null,nombre:s,dni:t.idxDni>=0?String(n[t.idxDni]||"").trim():"",correo:t.idxCorreo>=0?String(n[t.idxCorreo]||"").trim():"",fecha:t.idxNac>=0?String(n[t.idxNac]||"").trim():"",cel:t.idxCel>=0?String(n[t.idxCel]||"").trim():"",edad:t.idxEdad>=0?String(n[t.idxEdad]||"").trim():""})}return o}function yo(e,t){let o=0,a=0;const n=e.alumnos.find(s=>ne(s.nombre)===ne(t.nombre));if(n)!n.dni&&t.dni&&(n.dni=t.dni,o++),!n.correo&&t.correo&&(n.correo=t.correo,o++),!n.cel&&t.cel&&(n.cel=t.cel,o++),!n.fecha&&t.fecha&&(n.fecha=t.fecha,o++),!n.edad&&t.edad&&(n.edad=t.edad,o++);else{const s=Te(e);e.alumnos.push({...t,id:s}),e.asistencias[s]={},a++}return{actualizados:o,agregados:a}}function xo(e,t){let o=0,a=0,n=!1;return t.forEach(s=>{const i=Z(s);let r=0,l=0;e.forEach(d=>{const c=yo(i,d);r+=c.agregados,l+=c.actualizados}),(r>0||l>0)&&(xe(i),o+=r,a+=l,n=!0,T===s&&R(s))}),{totalAgregados:o,totalActualizados:a,needsSave:n}}async function Ke(e=!1){const t=_.find(n=>n.id==="tics_sabados");if(!t||!t.googleSheetCsvUrl)return;const o=["tics_S_1","tics_S_2","tics_S_3","tics_S_4"],a=t.googleSheetCsvUrl;try{const n=await fetch(a);if(!n.ok)throw new Error(`HTTP ${n.status}`);const s=await n.text(),i=At(s.replaceAll(`\r
`,`
`).replaceAll("\r",`
`)),r=bo(i);if(!r.length){e&&p("📋 El Sheet aún no tiene alumnos con datos");return}const{totalAgregados:l,totalActualizados:d,needsSave:c}=xo(r,o);c?(z(),T==="dashboard"&&ze(),e&&p(`✅ Sábados: ${l} inserciones, ${d} actualizaciones (total 4 módulos)`),typeof K=="function"&&l>0&&K("📅",`${l} inserciones de alumnos sincronizadas`,"Sábados M1-M4")):e&&p("✓ Sábados: sin cambios nuevos")}catch(n){e&&p("⚠️ Error al leer el Sheet de sábados: "+n.message),console.warn("[syncSheetTicsSabados]",n)}}setTimeout(()=>Ke(!1),2e3);setInterval(()=>Ke(!1),5*60*1e3);function $o(e){if(e==="dashboard")return"Resumen General";if(e==="personalizados")return"👤 Clases Personalizadas";if(e==="mensual")return"📅 Resumen Mensual";if(e==="historial")return"🕒 Historial de Cambios";if(e==="admin_carreras")return"⚙️ Gestión de Carreras";if(e==="horas"){const o=_.find(a=>a.id===$);return`🕐 Registro de Horas — ${(o==null?void 0:o.nombre)||""}`}if(e.startsWith("carrera_")){const o=e.split("carrera_")[1],a=_.find(n=>n.id===o);if(a)return`${a.icono} ${a.nombre} — Panel de Carrera`}const t=F(e);return t?`${t.seccion.label} — ${t.carrera.nombre}`:"Resumen General"}function Eo(e){if(e==="dashboard")ze();else if(e==="personalizados")ge();else if(e==="mensual"){const t=document.getElementById("mensualMes");t&&!t.value&&(t.value=U.slice(0,7))}else if(e!=="historial"){if(e==="admin_carreras")yt();else if(e==="horas")St(),fe();else if(!e.startsWith("carrera_")){const t=new Date().toISOString().split("T")[0],o=document.getElementById(`date-${e}`);o&&o.value!==t&&(o.value===U||o.value==="")&&(o.value=t),R(e),setTimeout(()=>jo(e),50)}}}function Oe(e){var t;document.querySelectorAll(".page").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(o=>o.classList.remove("active")),(t=document.getElementById(`page-${e}`))==null||t.classList.add("active"),document.querySelectorAll(".nav-item").forEach(o=>{o.getAttribute("onclick")===`goPage('${e}')`&&o.classList.add("active")}),T=e,document.getElementById("topbarTitle").textContent=$o(e),window.innerWidth<900&&(document.getElementById("sidebar").classList.add("hidden"),document.getElementById("sidebarOverlay").classList.remove("show")),Eo(e)}function Qe(){const e=_.find(n=>n.id===$);if(!e)return;const t=document.getElementById("logoMark");t&&(t.textContent=e.nombre);const o=document.getElementById("carrerasList");o&&(o.innerHTML=_.map(n=>`
          ...
          </div>`).join(""),o.innerHTML+='<button class="btn-nueva-carrera" onclick="showAddCarreraModal()">➕ Nueva Carrera</button>');const a=document.getElementById("mensualKey");a&&(a.innerHTML=_.flatMap(n=>n.secciones.map(s=>`<option value="${s.id}">${n.icono} ${s.label}</option>`)).join("")),document.querySelectorAll(".nav-item").forEach(n=>{n.classList.toggle("active",n.getAttribute("onclick")===`goPage('${T}')`)})}function So(e){if(e===$){const t=document.getElementById("cb-"+e);t&&t.classList.toggle("carrera-active");return}wt(e)}function Io(e,t){e!==$&&($=e,localStorage.setItem("currentGrupo",e)),Oe(t),Qe()}function wt(e){if(e===$)return;$=e,localStorage.setItem("currentGrupo",e),Qe(),!ue(e).includes(T)&&T!=="dashboard"&&T!=="personalizados"&&T!=="mensual"&&T!=="historial"&&T!=="horas"&&T!=="admin_carreras"&&!T.startsWith("carrera_")?Oe("dashboard"):T==="dashboard"&&ze()}async function wo(e,t){if(!t)return{alumnos:[],retirados:[],asistencias:{},fechas:[],motivos:{},notas:{},participacion:{}};const o=t.asistencias||{},a=t.fechas||[],n=(t.alumnos||[]).map(r=>({...r,id:Number(r.id)||r.id})),s=(t.retirados||[]).map(r=>({...r,id:Number(r.id)||r.id})),i={};return Object.entries(o).forEach(([r,l])=>{const d=isNaN(r)?r:Number(r);i[d]=l}),{alumnos:n,retirados:s,asistencias:i,fechas:a,motivos:t.motivos||{},notas:t.notas||{},participacion:t.participacion||{},emptiedAt:t.emptiedAt||null,updatedAt:t.updatedAt||null}}function _o(e,t,o,a){g[e]={alumnos:[],retirados:o.retirados||t.retirados||[],asistencias:{},fechas:[],motivos:{},notas:{},participacion:{}},a&&!se[e]&&(se[e]=Date.now(),ot()),z()}function Mo(e,t,o){g[e]={alumnos:t.alumnos||o.alumnos||[],retirados:t.retirados||o.retirados||[],asistencias:{...o.asistencias||{},...t.asistencias||{}},fechas:[...new Set([...t.fechas||[],...o.fechas||[]])].sort(),motivos:{...t.motivos||{},...o.motivos||{}},notas:an(t.notas,o.notas),participacion:{...t.participacion||{},...o.participacion||{}}},sn(),z()}async function Co(e,t,o,a){if(Le()){const n=document.getElementById("fbLoaderOverlay");n&&(n.style.display="flex");try{const s=await Fe.collection("modulos").doc(a).get();if(s.exists){const i=await wo(a,s.data()),r=Z(a),l=i.emptiedAt&&(i.alumnos||[]).length===0;nn(a,i,!0)?_o(a,i,r,l):Mo(a,i,r)}}catch(s){p("⚠️ No se pudo descargar datos a tiempo: "+s.message)}finally{n&&(n.style.display="none")}}Oe(a)}function Ao(e){const t={};e.secciones.forEach(a=>{let n="General";const s=a.label.toLowerCase();if(s.includes("módulo 1"))n="Módulo 1";else if(s.includes("módulo 2"))n="Módulo 2";else if(s.includes("módulo 3"))n="Módulo 3";else if(s.includes("módulo 4"))n="Módulo 4";else if(s.includes("módulo")){const i=s.match(/módulo\s*\d+/i);i&&(n=i[0].replace(/^m/i,"M"))}else n=a.label.includes("-")?a.label.split("-")[1].trim():a.label;t[n]||(t[n]=[]),t[n].push(a)});const o=Object.keys(t).map(a=>{let s=t[a].map(i=>{let r=i.label.includes("-")?i.label.split("-")[0].trim():i.badge;return r.toLowerCase().includes("mañana")?r="☀️ "+r:r.toLowerCase().includes("tarde")&&(r="🌙 "+r),`<button class="pill-btn" onclick="cargarAsistencia('${e.id}', '${a}', '${r}', '${i.id}')">${r}</button>`}).join("");return`
          <div class="mod-card">
  ...
  </div>`}function Bo(e,t){const o=t.files[0];if(!o)return;const a=new FileReader;a.onload=n=>{const s=XLSX.read(n.target.result,{type:"binary",cellDates:!0}),i=s.Sheets[s.SheetNames[0]],r=XLSX.utils.sheet_to_json(i,{header:1,defval:""}),l=_t(r);if(!l){p("❌ No se pudieron leer los datos del archivo.");return}g[e]=l,R(e),p(`✅ ${l.alumnos.length} alumnos importados en ${e.replace("-"," Módulo ")}`),t.value=""},a.readAsBinaryString(o)}function No(e){const t={};for(let a=1;a<e.length;a++){const n=e[a];let s=null;n instanceof Date?s=n.toISOString().split("T")[0]:n!==""&&n!==null&&(s=Lo(String(n).trim())),s&&(t[a]=s)}const o=[...new Set(Object.values(t))].sort();return{dateColMap:t,fechas:o}}function Po(e,t){const o=[],a={};for(let n=2;n<e.length;n++){const s=e[n],i=String(s[0]||"").trim();if(!i||i.length<2)continue;const r=i.toLowerCase();if(r.includes("total")||r.includes("nombre")||r.includes("alumno")||/^[=]/.test(i)||String(s[1]||"").startsWith("="))continue;const l=n;o.push({id:l,nombre:i}),a[l]={};for(const[d,c]of Object.entries(t)){const u=String(s[d]||"").trim();(u==="Presente"||u==="Falta"||u==="Permiso")&&(a[l][c]=u)}}return{alumnos:o,asistencias:a}}function _t(e){if(!e||e.length<3)return null;const{dateColMap:t,fechas:o}=No(e[0]),{alumnos:a,asistencias:n}=Po(e,t);return a.length===0?null:(a.sort((s,i)=>s.nombre.localeCompare(i.nombre,"es",{sensitivity:"base"})),{alumnos:a,asistencias:n,fechas:o})}function Lo(e){if(/^\d{4}[-\/]\d{1,2}[-\/]\d{1,2}$/.test(e)){const o=e.replace(/\//g,"-").split("-");return`${o[0]}-${o[1].padStart(2,"0")}-${o[2].padStart(2,"0")}`}if(/^\d{1,2}[-\/]\d{1,2}[-\/]\d{4}$/.test(e)){const o=e.split(/[-\/]/);return`${o[2]}-${o[1].padStart(2,"0")}-${o[0].padStart(2,"0")}`}const t=Number(e);return!isNaN(t)&&t>4e4&&t<6e4?new Date((t-25569)*86400*1e3).toISOString().split("T")[0]:null}let ae=JSON.parse(localStorage.getItem("google_sheets_sync")||"{}"),Se={};function Ye(){localStorage.setItem("google_sheets_sync",JSON.stringify(ae))}function Fo(e){const t=(e==null?void 0:e.googleSheetsSync)||(e==null?void 0:e.googleSheetsSyncConfig)||(e==null?void 0:e.google_sheets_sync);if(!t||typeof t!="object")return 0;let o=0;return Object.entries(t).forEach(([a,n])=>{var s;!a||!n||typeof n!="object"||(ae[a]={...ae[a]||{},...n},o++,(s=ae[a])!=null&&s.autoSync&&Ze(a))}),o>0&&Ye(),o}async function Oo(e,t){const o=`https://sheets.googleapis.com/v4/spreadsheets/${e}/values/Sheet1?key=${t}`,a=await fetch(o);if(!a.ok)throw new Error("Error al conectar con Google Sheets");const n=await a.json();if(!n.values||n.values.length===0)throw new Error("Hoja vacía");return n.values}function zo(e){return _t(e)}function Mt(e){const t=ae[e]||{};me();const o=`
...
📎 `+D.texto:""}" style="${D?"box-shadow:0 0 0 1.5px var(--amber)":""}"></div>`}).join("");return`
  ...
  </div>`;C(`${c} ${u?"Editar motivo":"Registrar "+a} — ${((v=d==null?void 0:d.nombre)==null?void 0:v.split(" ").slice(0,2).join(" "))||""}`,"",()=>{var x,S;const f=((x=document.getElementById("motivoTxt"))==null?void 0:x.value.trim())||"",b=(S=document.getElementById("fotoPreview"))==null?void 0:S.querySelector("img"),h=b?b.src:i.foto||"";n.asistencias[t][o]=a,n.fechas.includes(o)||(n.fechas.push(o),n.fechas.sort()),f||h?n.motivos[t][o]={texto:f,foto:h,tipo:a}:delete n.motivos[t][o],E(),R(e),z(),Ae(e),Pt(e,t);let y=" registrada";f&&(y=' — "'+f.substring(0,30)+(f.length>30?"...":"")+'"'),p(`${c} ${a}${y}`)},m),document.getElementById("mOk").textContent=u?"💾 Guardar cambios":`Registrar ${a}`,setTimeout(()=>{var b;const f=document.querySelector(".modal");f&&(f.style.maxWidth="520px"),(b=document.getElementById("motivoTxt"))==null||b.focus(),globalThis._pasteFotoHandler=async h=>{var x;const y=(x=h.clipboardData)==null?void 0:x.items;if(y){for(const S of y)if(S.type.startsWith("image/")){h.preventDefault();const D=S.getAsFile(),M=new FileReader;M.onload=H=>{const q=document.getElementById("fotoPreview");if(q){q.innerHTML=`<img src="${H.target.result}" alt="evidencia">`;const ie=q.parentElement;if(ie&&!ie.querySelector(".btn-quitar-foto")){const Q=document.createElement("button");Q.className="btn btn-red btn-quitar-foto",Q.style.cssText="font-size:.7rem;margin-top:6px;padding:3px 8px",Q.textContent="✕ Quitar foto",Q.onclick=qo,ie.appendChild(Q)}}p("📷 Imagen pegada")},M.readAsDataURL(D);break}}},document.addEventListener("paste",globalThis._pasteFotoHandler)},50)}globalThis._fotoBase64="";function qo(){const e=document.getElementById("fotoPreview");e&&(e.innerHTML="📷 Clic para subir foto"),globalThis._fotoBase64=""}function Vo(e,t){const o=g[e],a=o.alumnos.find(f=>f.id===t);if(!a)return;const n=o.asistencias[a.id]||{},s=o.motivos||{},i=Object.values(n).filter(f=>f==="Presente").length,r=Object.values(n).filter(f=>f==="Falta").length,l=Object.values(n).filter(f=>f==="Permiso").length,d=o.fechas.length,c=d>0?Math.round((i+l)/d*100):0;let u="var(--red)";c>=80?u="var(--green)":c>=60&&(u="var(--yellow)");const m=o.fechas.length===0?'<div style="color:var(--muted);font-size:.8rem;text-align:center;padding:12px">Sin clases registradas</div>':o.fechas.slice().reverse().map(f=>{var S;const b=n[f]||"—",h=(S=s[a.id])==null?void 0:S[f];let y="var(--muted)";b==="Presente"?y="var(--green)":b==="Falta"?y="var(--red)":b==="Permiso"&&(y="var(--blue)");let x="";return h&&(x=`<div style="flex:1">
  ...
  <div class="retirados-section">
    ...
    <div id="${n}" style="display:none">
  ...
  </div>`}function Ko(e,t){const o=g[e],a=o.alumnos.find(r=>r.id===t);if(!a)return;const{prefix:n,num:s,isLegacy:i}=_e(e);C("📤 Retirar alumno",`¿Confirmas retirar a "${a.nombre}"? Se retirará en este módulo y en los siguientes del mismo turno.`,async()=>{const r=[e];o.alumnos=o.alumnos.filter(l=>l.id!==t),o.retirados||(o.retirados=[]),o.retirados.some(l=>Number(l.id)===Number(a.id)||ne(l.nombre)===ne(a.nombre))||o.retirados.push({...a,retirado:!0}),[2,3,4,5,6,7,8,9].forEach(l=>{if(l<=s)return;const d=i?`${n}-${l}`:`${n}_${l}`;if(!g[d])return;const c=g[d],u=c.alumnos.find(m=>m.nombre.trim().toLowerCase()===a.nombre.trim().toLowerCase());u&&(c.alumnos=c.alumnos.filter(m=>m.id!==u.id),c.retirados||(c.retirados=[]),c.retirados.some(m=>Number(m.id)===Number(u.id)||ne(m.nombre)===ne(u.nombre))||c.retirados.push({...u,retirado:!0}),r.push(d))}),z(),R(e);try{await Promise.all(r.map(l=>Ve(l)))}catch(l){console.warn("Firebase sync error:",l)}E();if(typeof K=="function"){const l=e.replace("M-","Mañana M").replace("T-","Tarde M");K("📤",`${a.nombre} retirado`,l)}p(`📤 "${a.nombre}" retirado en módulo ${s} y siguientes`)})}async function Qo(e,t){const o=g[e];if(!o)return;const a=(o.retirados||[]).findIndex(i=>i.id===t);if(a===-1)return;const n=o.retirados[a];o.retirados.splice(a,1);const s={...n};delete s.retirado,o.alumnos.push(s),xe(o),z(),R(e);try{await bt(e,s)}catch(i){console.warn("Firebase sync error:",i)}p(`♻️ "${n.nombre}" reactivado`);if(typeof K=="function"){const i=e.replace("M-","Mañana M").replace("T-","Tarde M");K("♻️",`${n.nombre} reactivado`,i)}}function Yo(e,t){const o=Number(t),a=g[e];if(!a)return;const n=a.alumnos.find(r=>Number(r.id)===o);if(!n)return;const s=me().filter(r=>r!==e).map(r=>{const l=F(r);return`<option value="${r}">${l.carrera.nombre} - ${l.seccion.label}</option>`}).join(""),i=`
      ...
      </div>`;C("🔄 Mover Alumno","",()=>{const r=document.getElementById("selectDestinoMover").value;r&&(rn(e,r,t),E())},i)}function Z(e){g[e]||(g[e]={alumnos:[],retirados:[],asistencias:{},fechas:[],motivos:{},notas:{},participacion:{}});const t=g[e];return Array.isArray(t.alumnos)||(t.alumnos=[]),Array.isArray(t.retirados)||(t.retirados=[]),t.asistencias||(t.asistencias={}),Array.isArray(t.fechas)||(t.fechas=[]),t.motivos||(t.motivos={}),t.notas||(t.notas={}),t.participacion||(t.participacion={}),t}function ne(e){return String(e||"").trim().toLowerCase()}function et(e,t){const o=String(t);return[...e.alumnos||[],...e.retirados||[]].some(a=>String(a.id)===o)}function Te(e){const t=[...e.alumnos||[],...e.retirados||[]].map(a=>Number(a.id)).filter(Number.isFinite);let o=t.length?Math.max(...t)+1:1;for(;et(e,o);)o++;return o}function tt(e,t,o,a){const n=String(o),s=String(a),i=e.asistencias&&(e.asistencias[n]||e.asistencias[o])||{},r=e.motivos&&(e.motivos[n]||e.motivos[o])||{},l=e.participacion&&(e.participacion[n]??e.participacion[o]);t.asistencias||(t.asistencias={}),t.asistencias[s]||(t.asistencias[s]={}),Object.assign(t.asistencias[s],i);const d=new Set([...t.fechas||[],...e.fechas||[],...Object.keys(i)]);t.fechas=Array.from(d).sort((c,u)=>c.localeCompare(u)),Object.keys(r).length>0&&(t.motivos||(t.motivos={}),t.motivos[s]||(t.motivos[s]={}),Object.assign(t.motivos[s],r)),t.notas||(t.notas={}),Object.entries(e.notas||{}).forEach(([c,u])=>{var v,f;if(!u||!u.notas)return;const m=((v=u.notas)==null?void 0:v[n])??((f=u.notas)==null?void 0:f[o]);m!==void 0&&(t.notas[c]||(t.notas[c]={...u,notas:{}}),t.notas[c].notas||(t.notas[c].notas={}),t.notas[c].notas[s]=m)}),l!==void 0&&(t.participacion||(t.participacion={}),t.participacion[s]=l)}function Zo(e,t){const o=String(t);e.asistencias&&(delete e.asistencias[o],delete e.asistencias[t]),e.motivos&&(delete e.motivos[o],delete e.motivos[t]),e.participacion&&(delete e.participacion[o],delete e.participacion[t]),Object.values(e.notas||{}).forEach(a=>{a!=null&&a.notas&&(delete a.notas[o],delete a.notas[t])})}function ot(){localStorage.setItem("asist_empty_modules",JSON.stringify(se))}function nt(e){se[e]=Date.now(),ot()}function ko(e){se[e]&&(delete se[e],ot())}function en(e){var t;return!!se[e]&&(((t=g[e])==null?void 0:t.alumnos)||[]).length===0}function tn(e,t){var i;const o=((i=g[e])==null?void 0:i.alumnos)||[],a=(t==null?void 0:t.alumnos)||[];if(o.length>0||a.length===0)return!1;const n=a.map(r=>ne(r.nombre)).filter(Boolean);if(!n.length)return!1;const s=new Set;return me().forEach(r=>{var l;r!==e&&(((l=g[r])==null?void 0:l.alumnos)||[]).forEach(d=>{const c=ne(d.nombre);c&&s.add(c)})}),n.every(r=>s.has(r))}function on(e){if(!e)return 0;if(typeof e.toMillis=="function")return e.toMillis();if(typeof e.seconds=="number")return e.seconds*1e3+Math.floor((e.nanoseconds||0)/1e6);const t=Date.parse(e);return Number.isFinite(t)?t:0}function nn(e,t,o=!0){if(o&&(t==null?void 0:t.emptiedAt)&&(t.alumnos||[]).length===0)return!0;if(!en(e))return tn(e,t)?(nt(e),!0):!1;const n=((t==null?void 0:t.alumnos)||[]).length>0,s=on(t==null?void 0:t.updatedAt);return n&&s>(se[e]||0)?(ko(e),!1):!0}function an(...e){const t={};return e.forEach(o=>{Object.entries(o||{}).forEach(([a,n])=>{if(n){if(!t[a]){t[a]={...n,notas:{...n.notas||{}}};return}t[a]={...t[a],...n,notas:{...t[a].notas||{},...n.notas||{}}}}})}),t}function sn(){let e=!1;return me().forEach(t=>{const o=Z(t),a=new Set;o.alumnos.forEach(n=>{const s=String(n.id);if(!n.id||a.has(s)){const i=n.id,r=Te(o);tt(o,o,i,r),n.id=r,e=!0}a.add(String(n.id))})}),e}function rn(e,t,o){var c;const a=Number(o),n=Z(e),s=Z(t),i=n.alumnos.findIndex(u=>Number(u.id)===a);if(i===-1)return;const r=n.alumnos[i],l=s.alumnos.find(u=>ne(u.nombre)===ne(r.nombre));let d=r.id;l?d=l.id:(et(s,d)&&(d=Te(s)),s.alumnos.push({...r,id:d})),tt(n,s,r.id,d),n.alumnos.splice(i,1),Zo(n,r.id),n.alumnos.length===0&&nt(e),n.alumnos.sort((u,m)=>u.nombre.localeCompare(m.nombre,"es",{sensitivity:"base"})),s.alumnos.sort((u,m)=>u.nombre.localeCompare(m.nombre,"es",{sensitivity:"base"})),z(),V(e),V(t),R(e),p(`✅ ${r.nombre} transferido exitosamente.`),typeof K=="function"&&K("🔄",`${r.nombre} transferido a otra sección`,((c=F(t))==null?void 0:c.seccion.label)||t)}function Je(e){const t=e.match(/_([MmTtLl])_(\d+)$/);return t?Number.parseInt(t[2]):null}function ln(e,t){const o=Je(e);if(o!==3&&o!==4)return null;const a=o===3?4:3,n=e.replace(/_([MmTtLl])_(\d+)$/,`_$1_${a}`),s=Je(t);let i;if(s===null)return i=t,null;let r=a;return s===3?r=4:s===4&&(r=3),i=t.replace(/_([MmTtLl])_(\d+)$/,`_$1_${r}`),!g[n]||(g[n].alumnos||[]).length===0||!F(i)?null:{origenPar:n,destinoPar:i}}function gt(e,t){const o=Z(e),a=Z(t),n=[...o.alumnos];let s=0,i=0,r=0;return n.forEach(l=>{const d=a.alumnos.find(u=>ne(u.nombre)===ne(l.nombre));let c=l.id;d?(c=d.id,i++):(et(a,c)&&(c=Te(a),r++),a.alumnos.push({...l,id:c}),s++),tt(o,a,l.id,c)}),xe(a),o.alumnos=[],o.fechas=[],o.asistencias={},o.notas&&(o.notas={}),o.motivos&&(o.motivos={}),o.participacion&&(o.participacion={}),nt(e),{movidos:s,duplicados:i,idsReasignados:r}}function cn(e,t){var c,u;const o=F(e),a=F(t);if((((c=g[e])==null?void 0:c.alumnos)||[]).length===0){p("⚠️ El módulo origen no tiene alumnos.");return}const{movidos:s,duplicados:i,idsReasignados:r}=gt(e,t);z(),V(e),V(t),T===e&&R(e),T===t&&R(t),typeof K=="function"&&K("📦",`Módulo completo movido: ${(o==null?void 0:o.seccion.label)||e} → ${(a==null?void 0:a.seccion.label)||t}`,`${s} alumno(s)`);let l=`📦 ${s} alumno(s) movido(s)`;i>0&&(l+=` · ${i} ya existía(n)`),r>0&&(l+=` · ${r} ID(s) ajustado(s)`),p(l),E();const d=ln(e,t);if(d){const m=F(d.origenPar),v=F(d.destinoPar),f=(((u=g[d.origenPar])==null?void 0:u.alumnos)||[]).length;if(f>0){const b=Je(d.origenPar);setTimeout(()=>{C("📦 Mover módulo par también","",()=>{const h=gt(d.origenPar,d.destinoPar);z(),V(d.origenPar),V(d.destinoPar),T===d.origenPar&&R(d.origenPar),T===d.destinoPar&&R(d.destinoPar),typeof K=="function"&&K("📦",`Módulo par movido: ${(m==null?void 0:m.seccion.label)||d.origenPar} → ${(v==null?void 0:v.seccion.label)||d.destinoPar}`,`${h.movidos} alumno(s)`);let y=`📦 M${b}: ${h.movidos} alumno(s) movido(s)`;h.duplicados>0&&(y+=` · ${h.duplicados} ya existía(n)`),h.idsReasignados>0&&(y+=` · ${h.idsReasignados} ID(s) ajustado(s)`),p(y),E()},`<div style="font-size:.88rem;line-height:1.65;color:var(--text)">
    ...
    </div>`}).join("")+"</div>"}function mn(e,t){const o=g[e];if(!o||!t)return;const[a,n,s]=t.split("-"),i=s&&n&&a?`${s}/${n}/${a}`:t;C("Quitar fecha",`¿Deseas quitar la fecha ${i}? Se eliminarán las asistencias registradas ese día en este módulo.`,async()=>{o.fechas=(o.fechas||[]).filter(r=>r!==t),Object.values(o.asistencias||{}).forEach(r=>{r&&delete r[t]}),Object.values(o.motivos||{}).forEach(r=>{r&&delete r[t]}),z(),R(e);try{await Ve(e)}catch(r){p("Fecha quitada localmente, pero no se pudo sincronizar Firebase: "+r.message);return}E(),p(`Fecha ${i} quitada`)})}function Pt(e,t){var i;const o=g[e],a=o.alumnos.find(r=>r.id===t);if(!a)return;const n=Number.parseInt(((i=document.getElementById(`thr-${e}`))==null?void 0:i.value)||"3"),s=Object.values(o.asistencias[t]||{}).filter(r=>r==="Falta").length;s===n&&a.correo&&p(`⚠️ ${a.nombre} alcanzó ${s} faltas`)}function pn(e,t){var n;const o=g[e],a=((n=document.getElementById(`date-${e}`))==null?void 0:n.value)||U;o.alumnos.forEach(s=>{o.asistencias[s.id]||(o.asistencias[s.id]={}),o.asistencias[s.id][a]=t,Ae(e,s.id)}),o.fechas.includes(a)||(o.fechas.push(a),o.fechas.sort()),z(),Ae(e),R(e),p("✅ Todos marcados como Presente")}function fn(e,t){const o=g[e].alumnos.find(l=>l.id===t),{prefix:a,num:n,isLegacy:s}=_e(e),i=n===1,r=i?`¿Seguro que deseas eliminar a "${o==null?void 0:o.nombre}"? Se eliminará también de los demás módulos del mismo turno.`:`¿Seguro que deseas eliminar a "${o==null?void 0:o.nombre}" de este módulo?`;C("Eliminar alumno",r,()=>{const l=g[e];l.alumnos=l.alumnos.filter(d=>d.id!==t),delete l.asistencias[t],i&&o&&[2,3,4,5,6,7,8,9].forEach(d=>{const c=s?`${a}-${d}`:`${a}_${d}`;g[c]&&(g[c].alumnos=g[c].alumnos.filter(u=>u.nombre.trim().toLowerCase()!==o.nombre.trim().toLowerCase()))}),E(),z(),R(e),p(i?"✅ Alumno eliminado de todos los módulos":"✅ Alumno eliminado"),V(),o!=null&&o.fila&&Ve(e,o.fila,o.nombre)})}function gn(e){var d;const{prefix:t,num:o,isLegacy:a}=_e(e),n=g[e];if(!((d=n==null?void 0:n.alumnos)!=null&&d.length)){p("⚠️ Este módulo no tiene alumnos");return}const s=ue($),i=[2,3,4,5,6,7,8,9].filter(c=>c>o).filter(c=>{const u=a?`${t}-${c}`:`${t}_${c}`;return s.includes(u)});let r=0;const l=[];i.forEach(c=>{const u=a?`${t}-${c}`:`${t}_${c}`,m=g[u];if(!m)return;let v=0;n.alumnos.forEach(f=>{m.alumnos.some(h=>h.nombre.trim().toLowerCase()===f.nombre.trim().toLowerCase())||(m.alumnos.push({...f}),m.asistencias[f.id]||(m.asistencias[f.id]={}),v++)}),v>0?(xe(m),V(u),l.push(`M${c}: ${v} alumno(s)`),r+=v):l.push(`M${c}: ya sincronizado`)}),z(),r>0?p(`✅ ${l.join(" · ")}`):p("✓ Todos los módulos siguientes ya estaban sincronizados")}function vn(e){const t=F(e),o=t?`${t.seccion.label} — ${t.carrera.nombre}`:e;C(`➕ Agregar alumno — ${o}`,"",()=>{var m,v,f,b,h,y;const a=(m=document.getElementById("addNombreInp"))==null?void 0:m.value.trim();if(!a){p("⚠️ Escribe el nombre");return}const n=g[e],s=Date.now();n.alumnos.push({id:s,nombre:a,dni:((v=document.getElementById("addDniInp"))==null?void 0:v.value.trim())||"",fecha:((f=document.getElementById("addFechaInp"))==null?void 0:f.value)||"",edad:((b=document.getElementById("addEdadInp"))==null?void 0:b.value.trim())||"",correo:((h=document.getElementById("addCorreoInp"))==null?void 0:h.value.trim())||"",cel:((y=document.getElementById("addCelInp"))==null?void 0:y.value.trim())||""}),n.asistencias[s]={},xe(n);const i=n.alumnos.find(x=>x.id===s),{prefix:r,num:l,isLegacy:d}=_e(e),c=[];[2,3,4,5,6,7,8,9].filter(x=>x>l).forEach(x=>{const S=d?`${r}-${x}`:`${r}_${x}`,D=g[S];if(!D)return;D.alumnos.some(H=>H.nombre.trim().toLowerCase()===a.toLowerCase())||(D.alumnos.push({...i}),D.asistencias[s]={},xe(D),c.push("M"+x),V(S))}),E(),R(e);const u=c.length?` · copiado a ${c.join(", ")}`:"";p(`✅ "${a}" agregado${u}`),bt(e)},`<div class="form-grid" style="margin-top:4px">
    ...
    </div>`}).join("")}function In(e){const t=document.getElementById(`notasBody-${e}`);t&&(t.style.display=t.style.display==="none"?"":"none")}function wn(e){C("＋ Nuevo tema de evaluación","",()=>{var i,r;const o=(i=document.getElementById("ntNombre"))==null?void 0:i.value.trim();if(!o){p("⚠️ Escribe el nombre del tema");return}const a=Number.parseFloat((r=document.getElementById("ntMin"))==null?void 0:r.value)||11,n="tema_"+Date.now(),s=Be(e);s[n]={nombre:o,min:a,fecha:"",notas:{}},g[e].alumnos.forEach(l=>{s[n].notas[l.id]=""}),E(),Ne(e),V(e),p(`✅ Tema "${o}" creado`)},`
    ...
    </div>`),document.getElementById("mOk").textContent="Crear tema"}function _n(e,t,o,a){const n=Be(e);n[t]&&(n[t].notas[o]=a===""||a===null?"":Number.parseFloat(a),Ne(e),Xt(e))}function Mn(e,t){C("Eliminar tema","¿Eliminar este tema y todas sus notas?",()=>{const o=Be(e);delete o[t],E(),Ne(e),Kt(e),p("Tema eliminado")})}function at(e){const t=Z(e);return t.participacion||(t.participacion={}),t.participacion}function st(e){const t=document.getElementById(`part-section-${e}`);if(!t)return;const o=Z(e),a=at(e),n=o.alumnos;if(!n.length){t.innerHTML="";return}t.innerHTML=`
  ...
  </div>`}function Cn(e,t,o){const a=at(e);a[t]=o===""||o===null?"":Number.parseFloat(o),st(e),V(e)}function An(e){const t=Be(e),o=Object.entries(t);if(!o.length){p("⚠️ Primero crea un tema de evaluación en Notas");return}const a=at(e),s=g[e].alumnos.filter(r=>a[r.id]!==""&&a[r.id]!==null&&a[r.id]!==void 0);if(!s.length){p("⚠️ Primero ingresa puntos de participación");return}const i=`
    ...
    </div>`;C("➕ Sumar participación a nota","",()=>{var d;const r=(d=document.getElementById("sumaTemaId"))==null?void 0:d.value;if(!r||!t[r]){p("⚠️ Selecciona un tema");return}let l=0;s.forEach(c=>{var f;const u=Number.parseFloat(a[c.id])||0,m=Number.parseFloat((f=t[r].notas)==null?void 0:f[c.id])||0,v=Math.min(20,Math.round((m+u)*10)/10);t[r].notas[c.id]=v,l++}),E(),Ne(e),V(e),p(`✅ Participación sumada a ${l} alumno(s) en "${t[r].nombre}"`)},i),document.getElementById("mOk").textContent="Sumar participación"}function Ot(e,t,o,a){const{prefix:n,num:s}=_e(o),i=`${n.includes("M")?"Mañana":n.includes("T")?"Tarde":n} Módulo ${s}`,r=a.split("-").reverse().join("/"),l=`Hola ${e.split(" ")[0]}, se le recuerda que el día ${r} registró una falta en ${i}. Por favor comuníquese con su docente.`;it("whatsapp",e,t,"",l,o,a)}function Tn(e,t,o,a){const{prefix:n,num:s}=_e(o),i=`${n.includes("M")?"Mañana":n.includes("T")?"Tarde":n} Módulo ${s}`,r=a.split("-").reverse().join("/"),l=`Estimado/a ${e},
...
Atentamente,
Instituto Redes & TICs`;it("correo",e,"",t,l,o,a)}function it(e,t,o,a,n,s,i){const r=e==="whatsapp";let l="";r||(l=`<div class="fgroup"><div class="flabel">Asunto</div>
    ...
    <div style="display:flex;flex-direction:column;gap:12px;padding-top:4px">
      ...
      `).join("")}function Pn(e,t){const o=g[e];if(!o)return;const a=o.alumnos.find(m=>m.id===t);if(!a)return;const n=_.find(m=>m.id===$),s=((n==null?void 0:n.secciones)||[]).find(m=>m.id===e),i=s?s.label:e;document.getElementById("fichaNombre").textContent=a.nombre,document.getElementById("fichaCarrera").textContent=i;const r=a.cel||"999 999 999 (Simulado)";document.getElementById("fichaTelefono").textContent=r,document.getElementById("btnContactarTwilio").onclick=()=>{Ot(a.nombre,r,e,U)};const l=document.getElementById("fichaInasistenciasList"),d=o.asistencias[t]||{},c=Object.keys(d).filter(m=>d[m]==="Falta").sort().reverse();c.length===0?l.innerHTML='<div style="padding:10px; color:var(--muted); font-size:0.8rem; text-align:center;">No registra inasistencias</div>':l.innerHTML=c.slice(0,5).map(m=>`<div style="padding:8px 12px; border-bottom:1px solid var(--border); font-size:0.8rem; display:flex; justify-content:space-between;">
      ...
      <div class="fgroup" style="margin-bottom:16px">
        ...
        <select class="finp" id="expTemplate" onchange="renderExportForm()">
          ...
          ${Object.entries(Pe).map(([a,n])=>`<option value="${a}">${n.nombre}</option>`).join("")}
        </select>
      </div>
      <div id="exportFormContainer"></div>
      <div style="display:none" id="exportModOptionsHidden">${t}</div>
      `;C("📥 Exportar Documentos","",()=>{Dt()},o),document.getElementById("mOk").textContent="📥 Generar",document.getElementById("mOk").style.display="none",ce={template:"",wordMod:(T&&T.startsWith("redes_")?T:ue($)[0])||"",wordMap:{},excelSheets:{}}}window.renderExportForm=function(){const e=document.getElementById("expTemplate").value,t=document.getElementById("exportFormContainer"),o=document.getElementById("mOk");if(!e){t.innerHTML="",o.style.display="none",ce.template="";return}ce.template=e,o.style.display="block";const a=Pe[e],n=document.getElementById("exportModOptionsHidden").innerHTML;let s="";if(a.tipo==="word")s+=`
        ...
        `,t.innerHTML=s,ce.wordMod&&(document.getElementById("expWordMod").value=ce.wordMod),window.renderWordMapping(e);else if(a.tipo==="excel"&&(s+='<div style="font-size:.8rem;font-weight:600;margin-bottom:8px">Mapeo de Hojas</div>',s+='<div style="display:flex;flex-direction:column;gap:12px;max-height:45vh;overflow-y:auto;padding-right:8px">',a.hojas.forEach((i,r)=>{s+=`
        ...
        `,t.innerHTML=s,ce.wordMod)){const i=document.getElementById("expExcMod_0");i&&(i.value=ce.wordMod,window.renderExcelMapping(e,0))}};function Ht(e){return!e||!g[e]||!g[e].notas?'<option value="">(Sin asignar)</option>':'<option value="">(Sin asignar)</option>'+Object.entries(g[e].notas).map(([o,a])=>`<option value="${o}">${a.nombre}</option>`).join("")}window.renderWordMapping=function(e){const t=document.getElementById("expWordMod").value;ce.wordMod=t;const o=document.getElementById("expWordMappingPanel");if(!t){o.innerHTML='<div style="font-size:.75rem;color:var(--muted)">Selecciona un módulo arriba para mapear sus notas.</div>';return}const a=Pe[e],n=Ht(t);let s='<div style="font-size:.75rem;font-weight:600;margin-bottom:8px;color:var(--text)">Mapeo de Notas</div>';a.columnas.forEach(d=>{s+=`
          <div class="fgroup">
            <div class="flabel">Columna: ${d}</div>
            <select class="finp" id="expWordCol_${d.replaceAll(/\s+/g,"")}">${n}</select>
          </div>
        `}),o.innerHTML=s;const i=He[t]||{};document.getElementById("expWordProf").value=i.docente||"";const r=F(t);let l="";r&&r.seccion&&r.seccion.label&&(r.seccion.label.toLowerCase().includes("mañana")?l="Lunes - Miércoles - Viernes 09:00 - 13:00":r.seccion.label.toLowerCase().includes("tarde")&&(l="Lunes - Miércoles - Viernes 14:00 - 16:00")),document.getElementById("expWordTurno").value=l||i.horario||""};window.renderExcelMapping=function(e,t){const o=document.getElementById(`expExcMod_${t}`).value,a=document.getElementById(`expExcMap_${t}`);if(!o){a.innerHTML="";return}const s=Pe[e].hojas[t],i=Ht(o);let r="";if(s.columnas.forEach(l=>{r+=`
        ...
        `}),a.innerHTML=r,t===0){const l=He[o]||{};document.getElementById("expExcCurso").value||(document.getElementById("expExcCurso").value=l.curso||""),document.getElementById("expExcProf").value||(document.getElementById("expExcProf").value=l.docente||""),document.getElementById("expExcHorario").value||(document.getElementById("expExcHorario").value=l.horario||""),document.getElementById("expExcFechaI").value||(document.getElementById("expExcFechaI").value=l.fechaI||""),document.getElementById("expExcFechaF").value||(document.getElementById("expExcFechaF").value=l.fechaF||"")}};function Dt(){const e=ce.template;if(!e)return;const t=Pe[e];t.tipo==="word"?On(e,t):zn(e,t)}function On(e,t){var S,D;const o=document.getElementById("expWordMod").value;if(!o){p("⚠️ Selecciona un módulo origen");return}const a=g[o],n=document.getElementById("expWordProf").value.trim(),s=document.getElementById("expWordLugar").value.trim(),i=document.getElementById("expWordTurno").value.trim(),r={};t.columnas.forEach(M=>{const H=document.getElementById(`expWordCol_${M.replaceAll(/\s+/g,"")}`).value;r[M]=H});const l=[new docx.TableCell({children:[new docx.Paragraph({text:"N°",alignment:docx.AlignmentType.CENTER,style:"boldHeader"})],verticalAlign:docx.VerticalAlign.CENTER}),new docx.TableCell({children:[new docx.Paragraph({text:"Apellidos y Nombres",alignment:docx.AlignmentType.CENTER,style:"boldHeader"})],verticalAlign:docx.VerticalAlign.CENTER}),...t.columnas.map(M=>new docx.TableCell({children:[new docx.Paragraph({text:M,alignment:docx.AlignmentType.CENTER,style:"boldHeader"})],verticalAlign:docx.VerticalAlign.CENTER})),new docx.TableCell({children:[new docx.Paragraph({text:"Código de boleta",alignment:docx.AlignmentType.CENTER,style:"boldHeader"})],verticalAlign:docx.VerticalAlign.CENTER})],d=[new docx.TableRow({children:l,tableHeader:!0})];[...a.alumnos||[]].sort((M,H)=>M.nombre.localeCompare(H.nombre)).forEach((M,H)=>{const q=[new docx.TableCell({children:[new docx.Paragraph({text:String(H+1),alignment:docx.AlignmentType.CENTER})]}),new docx.TableCell({children:[new docx.Paragraph({text:M.nombre})]})];t.columnas.forEach(Q=>{const re=r[Q];let k="";if(re&&a.notas[re]&&(k=a.notas[re].notas[M.id],k==null||k==="")){const W=Object.entries(a.notas[re].notas).find(([j])=>String(j)===String(M.id));k=(W==null?void 0:W[1])??""}q.push(new docx.TableCell({children:[new docx.Paragraph({text:k!==""?String(Number(k)):"",alignment:docx.AlignmentType.CENTER})]}))});const ie=M.dni||`B-${String(Date.now()).slice(-6)}-${H+1}`;q.push(new docx.TableCell({children:[new docx.Paragraph({text:ie,alignment:docx.AlignmentType.CENTER})]})),d.push(new docx.TableRow({children:q}))});const m=(He[o]||{}).curso||((D=(S=F(o))==null?void 0:S.seccion)==null?void 0:D.label)||"MÓDULO",v=e==="informe_01"?"INFORME N° 001-2025-CEPTRO-DIMAS":"INFORME N° 001-2025-CEPTRO-DIMAS (Recuperación)",f=e==="informe_01"?`Evaluación modular – ${m.toUpperCase()}`:`Evaluación modular – ${m} (Recuperación)`,b=new Date().toLocaleDateString("es-ES",{year:"numeric",month:"long",day:"numeric"}),h=new Date().toLocaleString("es-ES",{month:"long"}),y=`Tengo el agrado de dirigirme a su digno despacho para saludarle y así mismo para informarle sobre la evaluación modular de ${m.toUpperCase()} de los estudiantes del turno de ${i}; la evaluación se desarrolló en el mes de ${h} obteniendo los resultados que se detallan en la siguiente tabla adjunta:`,x=new docx.Document({styles:{paragraphStyles:[{id:"Normal",name:"Normal",basedOn:"Normal",next:"Normal",run:{font:"Arial",size:22}},{id:"boldHeader",name:"Bold Header",basedOn:"Normal",run:{font:"Arial",size:22,bold:!0}},{id:"underlinedTitle",name:"Underlined Title",basedOn:"Normal",run:{font:"Arial",size:26,bold:!0,underline:{type:docx.UnderlineType.SINGLE}}}]},sections:[{properties:{},children:[new docx.Paragraph({text:v,alignment:docx.AlignmentType.CENTER,style:"underlinedTitle",spacing:{after:300}}),new docx.Paragraph({children:[new docx.TextRun({text:"AL :  ",bold:!0}),new docx.TextRun({text:"CEPTRO DIMAS"})],spacing:{after:100}}),new docx.Paragraph({children:[new docx.TextRun({text:"DEL : ",bold:!0}),new docx.TextRun({text:`Prof.: ${n}`})],spacing:{after:100}}),new docx.Paragraph({children:[new docx.TextRun({text:"ASUNTO : ",bold:!0}),new docx.TextRun({text:f})],spacing:{after:100}}),new docx.Paragraph({children:[new docx.TextRun({text:"FECHA: ",bold:!0}),new docx.TextRun({text:`${s}, ${b}`})],spacing:{after:300}}),new docx.Paragraph({text:y,spacing:{after:300},alignment:docx.AlignmentType.JUSTIFIED}),new docx.Table({rows:d,width:{size:100,type:docx.WidthType.PERCENTAGE}}),new docx.Paragraph({text:"",spacing:{after:800}}),new docx.Paragraph({text:"___________________________________",alignment:docx.AlignmentType.CENTER}),new docx.Paragraph({text:n,alignment:docx.AlignmentType.CENTER}),new docx.Paragraph({text:"Profesor",alignment:docx.AlignmentType.CENTER})]}]});docx.Packer.toBlob(x).then(M=>{var Q,re;const H=window.URL.createObjectURL(M),q=document.createElement("a");q.href=H;const ie=e==="informe_01"?"Informe_Modular":"Informe_Recuperacion";q.download=`${ie}_${((re=(Q=F(o))==null?void 0:Q.seccion)==null?void 0:re.badge)||"Modulo"}_${U}.docx`,q.click(),p("📥 Documento Word generado exitosamente"),E()}).catch(M=>{console.error(M),p("⚠️ Error generando Word")})}function zn(e,t){var d,c;const o=XLSX.utils.book_new(),a=document.getElementById("expExcCurso").value.trim(),n=document.getElementById("expExcProf").value.trim(),s=document.getElementById("expExcHorario").value.trim(),i=document.getElementById("expExcFechaI").value,r=document.getElementById("expExcFechaF").value;let l=new Set;if(t.hojas.forEach((u,m)=>{const v=document.getElementById(`expExcMod_${m}`).value;if(!v)return;l.add(v);const f=g[v];if(!f||!f.alumnos.length)return;const b={};u.columnas.forEach(j=>{b[j]=document.getElementById(`expExcCol_${m}_${j.replaceAll(/\s+/g,"")}`).value});const h=He[v]||{},y=[...f.fechas||[]].sort(),x=Array.from({length:6},(j,N)=>{const G=Math.floor(N*y.length/6),J=Math.floor((N+1)*y.length/6);return y.slice(G,J)}),S=[...f.alumnos].sort((j,N)=>j.nombre.localeCompare(N.nombre)),D=a||h.curso||u.nombre,M=n||h.docente||"",H=s||h.horario||"",q=i?Ce(i):h.fechaI?Ce(h.fechaI):"",ie=r?Ce(r):h.fechaF?Ce(h.fechaF):"",Q=(j,N)=>{const G=b[N];if(!G||!f.notas[G])return"";let J=f.notas[G].notas[j.id];if(J==null||J===""){const I=Object.entries(f.notas[G].notas).find(([w])=>String(w)===String(j.id));J=(I==null?void 0:I[1])??""}return J===""?"":Number(J)},re=(j,N)=>{if(!x[N]||!x[N].length)return"";const G=f.asistencias[j.id]||{};return x[N].filter(I=>(G[I]||"")==="Presente").length/x[N].length>.5?"P":"F"},k=j=>String.fromCharCode(65+j);let W;if(e==="registro_ofimatica"){const j=u.columnas.length,N=9,G=N+j,J=G+1,I=[],w=L=>{const X=Array(J).fill("");return X[2]=L,X};I.push(w(D)),I.push(w(M)),I.push(w(H)),I.push(w(q)),I.push(w(ie)),I.push(Array(J).fill(""));const A=Array(J).fill("");A[0]="N° ORDEN",A[1]="APELLIDOS y NOMBRES",A[2]="ASISTENCIA",u.columnas.forEach((L,X)=>{A[N+X]=L}),A[G]="PROM",I.push(A);const ve=Array(J).fill("");for(let L=0;L<6;L++)ve[2+L]=L+1;I.push(ve),S.forEach((L,X)=>{const he=9+X,le=Array(J).fill("");le[0]=X+1,le[1]=L.nombre;for(let ee=0;ee<6;ee++)le[2+ee]=re(L,ee);u.columnas.forEach((ee,Me)=>{le[N+Me]=Q(L,ee)}),le[G]={t:"n",f:`AVERAGE(${k(N)}${he}:${k(N+j-1)}${he})`},I.push(le)}),W=XLSX.utils.aoa_to_sheet(I),W["!cols"]=[{wch:5},{wch:33},{wch:4.5},{wch:4.5},{wch:4.5},{wch:4.5},{wch:4.5},{wch:4.5},{wch:2.5},...u.columnas.map(()=>({wch:5.5})),{wch:6}],W["!rows"]=[],W["!rows"][5]={hpt:11},W["!rows"][6]={hpt:30},W["!rows"][7]={hpt:22};const Y=[];for(let L=0;L<5;L++)Y.push({s:{r:L,c:2},e:{r:L,c:J-1}});Y.push({s:{r:6,c:0},e:{r:7,c:0}}),Y.push({s:{r:6,c:1},e:{r:7,c:1}}),Y.push({s:{r:6,c:2},e:{r:6,c:7}}),u.columnas.forEach((L,X)=>Y.push({s:{r:6,c:N+X},e:{r:7,c:N+X}})),Y.push({s:{r:6,c:G},e:{r:7,c:G}}),W["!merges"]=Y}else{const j=u.columnas.length,N=21,G=25,J=26,I=17,w=[],A=()=>Array(J).fill("");w.push(A());const ve=A();ve[1]="REGISTRO DE EVALUACIÓN",ve[17]="ESPECIALIDAD",ve[22]="Computación e Informática",w.push(ve),w.push(A());const Y=A();Y[0]="TOTAL MATRICULADOS",Y[2]=S.length,Y[17]="MÓDULO",Y[22]="Diseño Gráfico",w.push(Y),w.push(A());const L=A();L[0]="ALUMNOS APROBADOS",L[17]="PROGRAMA",L[22]=u.nombre,w.push(L),w.push(A());const X=A();X[0]="ALUMNOS DESAPROBADOS",X[17]="DÍAS DE CLASE",X[22]=H||"Sábado",w.push(X),w.push(A());const he=A();he[0]="ALUMNOS INHABILITADOS",he[17]="HORAS",he[22]=h.horario||"",w.push(he),w.push(A());const le=A();le[17]="FECHA DE INICIO",le[22]=q,w.push(le),w.push(A());const ee=A();ee[0]="CLASES DICTADAS",ee[2]=y.length,ee[17]="FECHA DE TÉRMINO",ee[22]=ie,w.push(ee),w.push(A());const Me=A();Me[17]="PROFESORA",Me[22]=M,w.push(Me),w.push(A());const be=A();be[0]="N°",be[1]="APELLIDOS Y NOMBRES",be[2]="ASISTENCIA",be[20]="N°",u.columnas.forEach((O,pe)=>{be[N+pe]=O}),be[G]="NOTA FINAL",w.push(be);const ct=A();for(let O=0;O<6;O++)ct[2+O]=O+1;w.push(ct),S.forEach((O,pe)=>{const dt=20+pe,ye=A();ye[0]=pe+1,ye[1]=O.nombre,ye[20]=pe+1;for(let Ee=0;Ee<6;Ee++)ye[2+Ee]=re(O,Ee);u.columnas.forEach((Ee,Rt)=>{ye[N+Rt]=Q(O,Ee)}),ye[G]={t:"n",f:`AVERAGE(${k(N)}${dt}:${k(N+j-1)}${dt})`},w.push(ye)}),W=XLSX.utils.aoa_to_sheet(w),W["!cols"]=[{wch:5},{wch:30},{wch:4},{wch:4},{wch:4},{wch:4},{wch:4},{wch:4},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:3},{wch:5},...u.columnas.map(()=>({wch:7})),{wch:4},{wch:8}].slice(0,J),W["!rows"]=[],W["!rows"][I]={hpt:30},W["!rows"][I+1]={hpt:22};const te=[];[1,3,5,7,9,11,13,15].forEach(O=>{te.push({s:{r:O,c:17},e:{r:O,c:20}}),te.push({s:{r:O,c:22},e:{r:O,c:25}})}),[3,5,7,9,13].forEach(O=>te.push({s:{r:O,c:0},e:{r:O,c:1}})),[3,13].forEach(O=>te.push({s:{r:O,c:2},e:{r:O,c:5}})),te.push({s:{r:1,c:1},e:{r:1,c:4}}),te.push({s:{r:I,c:0},e:{r:I+1,c:0}}),te.push({s:{r:I,c:1},e:{r:I+1,c:1}}),te.push({s:{r:I,c:2},e:{r:I,c:7}}),te.push({s:{r:I,c:20},e:{r:I+1,c:20}}),u.columnas.forEach((O,pe)=>te.push({s:{r:I,c:N+pe},e:{r:I+1,c:N+pe}})),te.push({s:{r:I,c:G},e:{r:I+1,c:G}}),W["!merges"]=te}XLSX.utils.book_append_sheet(o,W,u.nombre.slice(0,31))}),o.SheetNames.length>0){let u="";if(l.size===1){const v=[...l][0];u="_"+(((c=(d=F(v))==null?void 0:d.seccion)==null?void 0:c.badge)||v)}const m=e==="registro_ofimatica"?"Registro_Curso":"Registro_Taller";XLSX.writeFile(o,`${m}${u}_${U}.xlsx`),p(`📥 Excel generado con ${o.SheetNames.length} hoja(s)`),E()}else p("⚠️ No se seleccionaron módulos con alumnos para ninguna hoja.")}function Ce(e){if(!e)return"";const[t,o,a]=e.split("-");return`${a}/${o}/${t}`}function Hn(){zt()}function Le(){return!!Fe}const Dn=["fer250423@gmail.com"];function rt(e){if(!de)try{de=firebase.initializeApp(e),Fe=firebase.firestore(de),localStorage.setItem("fb_config",JSON.stringify(e)),Rn()}catch(t){console.error("Firebase init error:",t)}}function lt(e){try{return JSON.parse(e)}catch{}try{const t=e.replace(/\/\/.*$/gm,"").replace(/(\w+)(\s*):/g,'"$1":').replaceAll("'",'"');return JSON.parse(t)}catch{}try{const t=e.match(/\{[\s\S]+\}/);if(t)return JSON.parse(t[0])}catch{}throw new Error("No se pudo parsear la configuración")}function We(){const e=localStorage.getItem("fb_config");let t=e||"";try{t=JSON.stringify(JSON.parse(t),null,2)}catch{}const o=`
  ...
  "appId": "..."
    ...
    </div>`;C("🔥 Configurar Firebase","",()=>{const a=document.getElementById("fbConfigInput").value.trim();if(!a){p("⚠️ Pega la configuración");return}try{const n=lt(a);rt(n),E(),p("✅ Firebase configurado")}catch(n){p("⚠️ Config inválida: "+n.message)}},o),document.getElementById("mOk").textContent="Guardar y conectar"}function Rn(){de&&firebase.auth(de).onAuthStateChanged(e=>{const t=document.getElementById("loginScreen"),o=document.getElementById("mainLayout");e?Dn.includes(e.email)?(t.style.display="none",o.style.display="flex"):(document.getElementById("loginError").style.display="block",firebase.auth(de).signOut()):(t.style.display="flex",o.style.display="none")})}function jn(){if(!de){const t=localStorage.getItem("fb_config");if(t)try{rt(lt(t))}catch(o){console.error("Config inválida guardada:",o),We();return}else{We();return}}const e=new firebase.auth.GoogleAuthProvider;firebase.auth(de).signInWithPopup(e).then(t=>{const o=t.user;document.getElementById("loginScreen").style.display="none",document.getElementById("mainLayout").style.display="flex",console.log("Login exitoso:",o.email)}).catch(t=>{console.error("Error en login:",t),t.code==="auth/popup-blocked"?alert("El navegador bloqueó la ventana emergente. Permite popups para este sitio."):alert("Error al iniciar sesión: "+t.message)})}function Gn(){firebase.auth(de).signOut().then(()=>{document.getElementById("loginScreen").style.display="flex",document.getElementById("mainLayout").style.display="none"})}const Jn={loginWithGoogle:jn,logoutGoogle:Gn,applyTheme:Ue,toggleTheme:jt,showToast:p,showModal:C,closeModal:E,goPage:Oe,switchGrupoAndPage:Io,switchGrupo:wt,toggleSidebar:Gt,toggleCarreraBlock:So,globalSearch:Jt,closeGlobalSearch:Wt,showFirebaseConfig:We,showExportModal:zt,exportarBackupJSON:po,importarBackupJSON:fo,showAddCarreraModal:oo,cargarAsistencia:Co,importExcel:Bo,showGoogleSheetsSyncModal:Mt,showAddAlumnoModal:vn,propagarAlumnos:gn,showMoverModuloCompleto:dn,setDateQuick:Ro,onDateChange:Bt,setAsist:Go,setAsistConMotivo:Uo,marcarTodos:pn,showPerfil:Vo,enviarWhatsApp:Ot,enviarCorreo:Tn,showMensajeModal:it,showEditarAlumno:hn,showMoverAlumno:Yo,eliminarAlumno:fn,retirarAlumno:Ko,reactivarAlumno:Qo,quitarFechaModulo:mn,renderPersonalizados:ge,agregarPersonalizado:bn,editarPersonalizado:Sn,eliminarPersonalizado:En,showRegistrarClaseModal:yn,registrarClasePersonalizada:Lt,quitarClasePersonalizada:$n,selectRcVal:Ft,rcAutoHoras:xn,showAddNotaModal:wn,toggleNotasTema:In,setNota:_n,eliminarTema:Mn,renderParticipacion:st,setParticipacion:Cn,showSumarParticipacionModal:An,renderMensual:kt,renderHistorialMini:eo,renderAdminCarreras:yt,clearHistorial:mo,renderHoras:fe,initHorasForm:St,sincronizarHorasLog:ke,showAgregarHoraManual:Wo,setClaseBase:lo,actualizarHora:co,eliminarHora:uo,showPromptClaseInfo:Ge,abrirFichaAlumno:Pn,cerrarFichaAlumno:Ln,renderExportForm,renderWordMapping,renderExcelMapping,generarExportacion:Dt,exportarTodo:Hn,fmtFechaMeta:Ce,syncSheetTicsSabados:Ke,eliminarCarrera:to};Object.entries(Jn).forEach(([e,t])=>{window[e]=t});
